...
<link href="<?php echo $data['config']['THEME_DIR']; ?>css/admin.global.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<?php echo $data['config']['THEME_DIR']; ?>js/jquery/jquery-1.7.1.min.js"></script>
<!-- Nav Menu -->
<link rel="stylesheet" type="text/css" href="<?php echo $data['config']['SITE_URL']; ?>/lib/superfish/css/admin.superfish.css" media="screen">
