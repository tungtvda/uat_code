...
class TransactionStatus extends BaseController 
{
	protected $controller_name = "transactionstatus";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['transactionstatus_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/transactionstatus/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/transactionstatus/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_DIR']."/admin/transactionstatus/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['transactionstatus_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/transactionstatus/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/transactionstatus/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['transactionstatus_delete'] = $param['status'];
