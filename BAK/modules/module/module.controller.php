...
{
	protected $controller_name = "module";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['module_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/module/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/module/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_DIR']."/admin/module/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['module_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/module/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/module/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['module_delete'] = $param['status'];
