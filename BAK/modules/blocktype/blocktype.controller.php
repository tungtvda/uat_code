...
class BlockType extends BaseController 
{
	protected $controller_name = "blocktype";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['blocktype_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/blocktype/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/blocktype/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_DIR']."/admin/blocktype/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['blocktype_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/blocktype/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/blocktype/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['blocktype_delete'] = $param['status'];
