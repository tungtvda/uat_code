...
class DeliveryMethod extends BaseController 
{
	protected $controller_name = "deliverymethod";
	...
	protected function AddProcess()
	{
        ...
        {
			$_SESSION['admin']['deliverymethod_add'] = $param['status'];
	        
	        if ($param['status']['ok']=="1") 
			{
				Helper::redirect($param['config']['SITE_URL']."/admin/deliverymethod/edit/".$param['content_param']['newID']);
			} 
			else 
			{
				Helper::redirect($param['config']['SITE_URL']."/admin/deliverymethod/add/");
			}
        }
        else if ($this->section=='api')
        {
	...
	protected function Edit() 
	{
        ...
        else if ($this->section=='admin')
        {
	        ...
	        {
	            Helper::redirect($param['config']['SITE_URL']."/admin/deliverymethod/index");
	        }
        }
        else if ($this->section=='api')
        {
	...
	protected function EditProcess() 
	{
        ...
        {
			$_SESSION['admin']['deliverymethod_edit'] = $param['status'];
	        
	        if ($param['status']['ok']=="1") 
			{
				Helper::redirect($param['config']['SITE_URL']."/admin/deliverymethod/edit/".$this->id);
			} 
			else 
			{
				Helper::redirect($param['config']['SITE_URL']."/admin/deliverymethod/edit/".$this->id);
	...
	protected function Delete() 
	{
        ...
        {
			$_SESSION['admin']['deliverymethod_delete'] = $param['status'];
