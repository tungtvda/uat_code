<?php if ($data['page']['resellercredit_add']['error']['count']>0) { ?>
<?php } else { ?>
    <?php if ($data['page']['resellercredit_add']['ok']==1) { ?>
    <div class="notify">Transaction created successfully.</div>
    <?php } ?>
<?php } ?>
<?php if ($data['page']['resellercredit_edit']['error']['count']>0) { ?>
<?php } else { ?>
    <?php if ($data['page']['resellercredit_edit']['ok']==1) { ?>
    <div class="notify">Transaction edited successfully.</div>
    <?php } ?>
<?php } ?>
<form name="edit_form" class="admin_table_nocell"  id="edit_form" action="<?php echo $data['config']['SITE_DIR']; ?>/admin/resellercredit/editprocess/<?php echo $data['content'][0]['ID']; ?>" method="post">
  <table border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td><select name="ResellerID" class="chosen">
          ...
          <option value="<?php echo $data['content_param']['reseller_list'][$i]['ID']; ?>" <?php if ($data['content_param']['reseller_list'][$i]['ID']==$data['content'][0]['ResellerID']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['reseller_list'][$i]['Name']; ?></option>
          <?php } ?>
        </select></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="submit" name="submit" value="Update" class="button" />
        <a href="<?php echo $data['config']['SITE_DIR']; ?>/admin/resellercredit/index">
