...
{
	protected $controller_name = "productcategory";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['productcategory_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/productcategory/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/productcategory/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_DIR']."/admin/productcategory/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['productcategory_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/productcategory/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/productcategory/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['productcategory_delete'] = $param['status'];
