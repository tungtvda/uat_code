	    ...
	    <table border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td><select name="MemberID" class="chosen">
	            ...
	            <option value="<?php echo $data['content_param']['member_list'][$i]['ID']; ?>" <?php if ($data['content_param']['member_list'][$i]['ID']==$_SESSION['wallet_AgentIndex']['param']['MemberID']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['member_list'][$i]['Name']; ?> | <?php echo $data['content_param']['member_list'][$i]['Username']; ?></option>
	            <?php } ?>
	          </select></td>
	        <td>&nbsp;</td>
	        <td>Total</label></td>
	      ...
	      <tr>
	        ...
	        <td>&nbsp;</td>
	      	...
	      	<td>
                    ...
                    <option value="<?php echo $data['agent'][0]['ID']; ?>" <?php if($_SESSION['wallet_AgentIndex']['param']['AgentID']==$data['agent'][0]['ID']){ ?>selected="selected"<?php } ?>><?php echo $data['agent'][0]['Name']; ?> - <?php echo $data['agent'][0]['ID']; ?></option>
