...
<!--	        <td><select name="AgentID" class="chosen_full">
	            ...
	            <option value="<?php echo $data['content_param']['agent_list'][$i]['ID']; ?>" <?php if ($data['content_param']['agent_list'][$i]['ID']==$_SESSION['agentblock_AdminIndex']['param']['AgentID']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['agent_list'][$i]['Name']; ?></option>
	            <?php } ?>
	          </select></td>-->
                <?php //Debug::displayArray($data['content_param']['test1']); ?>
                  <td>
                    ...
                    <option value="<?php echo $data['content_param']['test1'][$g]['ID']; ?>" <?php if($data['content_param']['test1'][$g]['ID']==$_SESSION['agentblock_AdminIndex']['param']['AgentID']){ ?>selected="selected"<?php } ?>><?php echo $data['content_param']['test1'][$g]['Name']; ?> - <?php echo $data['content_param']['test1'][$g]['ID']; ?></option>
	            ...
	            <option value="<?php echo $data['content_param']['test2'][$i]['ID']; ?>" <?php if ($data['content_param']['test2'][$i]['ID']==$_SESSION['agentblock_AdminIndex']['param']['AgentID']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['test2'][$i]['Name']; ?></option>
	            <?php } ?>
                    </select>
                </td>
	        <td>&nbsp;</td>
