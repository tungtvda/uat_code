	      ...
	      <tr>
	        <th scope="row"><label>Agent</label></th>
	      	<td>
                    ...
                    <option value="<?php echo $data['agent'][0]['ID']; ?>" <?php if($data['agent'][0]['ID']==$_SESSION['agentblock_AgentIndex']['param']['AgentID']){ ?>selected="selected"<?php } ?>><?php echo $data['agent'][0]['Name']; ?> - <?php echo $data['agent'][0]['ID']; ?></option>
