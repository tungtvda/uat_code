...
class AgentBlockModel extends BaseModel
{
        ...
        public function getAgentBlockByAgent($agent, $type) 
	{
		...
		$sql = "SELECT * FROM agent_block WHERE AgentID = '".$agent."' AND Enabled = '1' AND Position IN ('Withdrawal Top', 'Withdrawal Bottom', 'Withdrawal Popup')";
		...
		$sql = "SELECT * FROM agent_block WHERE AgentID = '".$agent."' AND Enabled = '1' AND Position = 'Transfer Popup'";
		...
		$sql = "SELECT * FROM agent_block WHERE AgentID = '".$agent."' AND Enabled = '1' AND Position IN ('Deposit Top', 'Deposit Bottom', 'Deposit Popup')";
		...
		$sql = "SELECT * FROM agent_block WHERE AgentID = '".$agent."' AND Enabled = '1' AND Position = 'Login'";
	...
	{
            $BackgroundColour = AgentModel::getAgent($agent, "BackgroundColour");
            $FontColour = AgentModel::getAgent($agent, "FontColour");
