	      ...
	      <tr>
	        <th scope="row"><label>Agent</label></th>
	      	<td>
                    ...
                    <option value="<?php echo $data['agent'][0]['ID']; ?>" <?php if($_SESSION['agentpromotion_AgentIndex']['param']['AgentID']==$data['agent'][0]['ID']){ ?>selected="selected"<?php } ?>><?php echo $data['agent'][0]['Name']; ?> - <?php echo $data['agent'][0]['ID']; ?></option>
