<form name="add_form" class="admin_table_nocell"  id="add_form" action="<?php echo $data['config']['SITE_URL']; ?>/admin/booking/listingaddprocess/<?php echo $data['parent']['id']; ?>" method="post">
  <table border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td><select name="Status" class="chosen_simple">
            ...
            <option value="<?php echo $data['content_param']['bookingstatus_list'][$i]['ID']; ?>"><?php echo $data['content_param']['bookingstatus_list'][$i]['Label']; ?></option>
            <?php } ?>
          </select></td>
    </tr>
    <tr>
    ...
    <tr>
      <th scope="row">&nbsp;</th>
      <td><input type="submit" name="submit" value="Add" class="button" /> <a href="<?php echo $data['config']['SITE_URL']; ?>/admin/booking/listingindex/<?php echo $data['parent']['id']; ?>"><input type="button" value="Cancel" class="button" /></a></td>
    </tr>
  </table>
</form>
