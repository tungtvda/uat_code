...
<div id="search_box"<?php if ($data['content_param']['search']=="off") { ?>class="search_initial"<?php } ?>>
  ...
  <div id="search_content" <?php if ($data['content_param']['search']=="off") { ?>class="invisible"<?php } ?>>
	  ...
	  <form name="search_form" class="admin_table_nocell"  id="search_form" action="<?php echo $data['config']['SITE_DIR']; ?>/admin/agent/report" method="post">
	    ...
	    <table border="0" cellspacing="0" cellpadding="0" style="width:100%">
	      <tr>
            ...
            <td><select name="Year" class="chosen_simple">
                ...
                <option value="<?php echo $data['filters']['years'][$i]; ?>" <?php if ($data['filters']['years'][$i]==$_SESSION['agent_AdminReport']['Year']) { ?> selected ="selected" <?php } ?>><?php echo $data['filters']['years'][$i]; ?></option>
                <?php } ?>
              </select></td>
              <td>&nbsp;</td>
            ...
            <td><select name="Month" class="chosen_simple">
                ...
                <option value="<?php echo $data['filters']['months'][$i]; ?>" <?php if ($data['filters']['months'][$i]==$_SESSION['agent_AdminReport']['Month']) { ?> selected ="selected" <?php } ?>><?php echo $data['filters']['months'][$i]; ?></option>
                <?php } ?>
              </select></td>
...
<!--	      	<td><select name="Agent" class="chosen_full">
	            ...
	            <option value="<?php echo $data['content_param']['agent_list'][$i]['ID']; ?>" <?php if ($data['content_param']['agent_list'][$i]['ID']== $_SESSION['agent_AdminReport']['Agent']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['agent_list'][$i]['Name']; ?> - <?php echo $data['content_param']['agent_list'][$i]['ID']; ?></option>
	            <?php } ?>
	          </select></td>-->
                  <td>
                    ...
                    <option value="<?php echo $data['content_param']['agent_list1'][$g]['ID']; ?>" <?php if($data['content_param']['agent_list1'][$g]['ID']==$_SESSION['agent_AdminReport']['Agent']){ ?>selected="selected"<?php } ?>><?php echo $data['content_param']['agent_list1'][$g]['Name']; ?> - <?php echo $data['content_param']['agent_list1'][$g]['ID']; ?></option>
	            <?php Helper::agentOptionList($data['content_param']['agent_list1'][$g]['Child'], $_SESSION['agent_AdminReport']['Agent']); ?>
                    <?php } ?>
                    <?php for ($i=0; $i<$data['content_param']['agent_list2']['count']; $i++) { ?>
	            <option value="<?php echo $data['content_param']['agent_list2'][$i]['ID']; ?>" <?php if ($data['content_param']['agent_list2'][$i]['ID']==$_SESSION['agent_AdminReport']['Agent']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['agent_list2'][$i]['Name']; ?></option>
	            <?php } ?>
                    </select>
                </td>
	        <td>&nbsp;</td>
	      ...
	      <tr>
	        ...
	        <td class="text_right"><input type="submit" name="submit" value="Search" class="button" />
	          <a href="<?php echo $data['config']['SITE_DIR']; ?>/admin/agent/report?page=all">
...
<div class="admin_results">
  ...
  <div class="results_right"><!--<a href='/admin/transaction/add/'>
    ...
    <a href='<?php echo $data['config']['SITE_DIR']; ?>/admin/agent/reportexport/AdminReport'>
