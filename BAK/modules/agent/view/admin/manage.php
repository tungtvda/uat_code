<div id="search_box"<?php if ($data['content_param']['search']=="off") { ?>class="search_initial"<?php } ?>>
  ...
  <div id="search_content" <?php if ($data['content_param']['search']=="off") { ?>class="invisible"<?php } ?>>
	  ...
	  <form name="search_form" class="admin_table_nocell"  id="search_form" action="<?php echo $data['config']['SITE_DIR']; ?>/admin/agent/manage" method="post">
	    ...
	    <table border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td>
                    ...
                    <option value="" selected="selected" disabled="disabled">--Select All--</option> 
                    <?php for ($g=0; $g<$data['content_param']['test1']['count']; $g++) { ?>
                    <option value="<?php echo $data['content_param']['test1'][$g]['ID']; ?>" <?php if($data['content_param']['test1'][$g]['ID']==$_SESSION['agent_AdminManage']['param']['Agent']){ ?>selected="selected"<?php } ?>><?php echo $data['content_param']['test1'][$g]['Name']; ?> - <?php echo $data['content_param']['test1'][$g]['ID']; ?></option>
	            <?php Helper::agentOptionList($data['content_param']['test1'][$g]['Child'], $_SESSION['agent_AdminManage']['param']['Agent']); ?>
                    <?php } ?>
                    <?php for ($i=0; $i<$data['content_param']['test2']['count']; $i++) { ?>
	            <option value="<?php echo $data['content_param']['test2'][$i]['ID']; ?>" <?php if ($data['content_param']['test2'][$i]['ID']==$_SESSION['agent_AdminManage']['param']['Agent']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['test2'][$i]['Name']; ?></option>
	            <?php } ?>
                    </select>
                </td>
	        <td>&nbsp;</td>
	        ...
	        <td><select name="Product" class="chosen">
	            <option value="" selected="selected" disabled="disabled">All Product</option>
	            <?php for ($i=0; $i<$data['content_param']['product_list']['count']; $i++) { ?>
	            <option value="<?php echo $data['content_param']['product_list'][$i]['ID']; ?>" <?php if ($_SESSION['agent_AdminManage']['param']['Product']==$data['content_param']['product_list'][$i]['ID']) { ?>selected="selected"<?php } ?>><?php echo $data['content_param']['product_list'][$i]['Name']; ?></option>
	            <?php } ?>
	        </select></td>
	      </tr>
	      <tr>
                <th>Name</th>
                <td><input name="Name" type="text" value="<?php echo $_SESSION['agent_AdminManage']['param']['Name']; ?>" /></td>  
                <td>&nbsp;</td>
	        <th scope="row">Enabled</th>
                <td><select name="Enabled" class="chosen_simple">
	            <option value="" selected="selected" disabled="disabled">All Status</option>
	            <?php for ($i=0; $i<$data['content_param']['enabled_list']['count']; $i++) { ?>
	            <option value="<?php echo $data['content_param']['enabled_list'][$i]['ID']; ?>" <?php if ($_SESSION['agent_AdminManage']['param']['Enabled']==$data['content_param']['enabled_list'][$i]['ID']) { ?>selected="selected"<?php } ?>><?php echo $data['content_param']['enabled_list'][$i]['Value']; ?></option>
	            <?php } ?>
	          </select></td>	        
	      </tr>	      
	      <tr>
	      ...
	      <tr>
	        ...
	        <td class="text_right"><input type="submit" name="submit" value="Search" class="button" />
	          <a href="<?php echo $data['config']['SITE_DIR']; ?>/admin/agent/manage?page=all">
...
<div class="admin_results">
  ...
  <div class="results_right"><a href='/admin/agent/index?page=all'>
