...
<?php if ($data['page']['agent_edit']['error']['count']>0) { ?>
    <div class="error">
        <ul>
            ...
            <?php if ($data['page']['agent_edit']['error']['PlatformEmail1']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail1']; ?> exists in the database. Please try again with another platform email 1.</li><?php } ?>
            <?php if ($data['page']['agent_edit']['error']['PlatformEmail2']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail2']; ?> exists in the database. Please try again with another platform email 2.</li><?php } ?>
            <?php if ($data['page']['agent_edit']['error']['PlatformEmail3']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail3']; ?> exists in the database. Please try again with another platform email 3.</li><?php } ?>
            <?php if ($data['page']['agent_edit']['error']['PlatformEmail4']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail4']; ?> exists in the database. Please try again with another platform email 4.</li><?php } ?>
            <?php if ($data['page']['agent_edit']['error']['PlatformEmail5']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail5']; ?> exists in the database. Please try again with another platform email 5.</li><?php } ?>
            <?php if ($data['page']['agent_edit']['error']['PlatformEmail6']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail6']; ?> exists in the database. Please try again with another platform email 6.</li><?php } ?>
            <?php if ($data['page']['agent_edit']['error']['PlatformEmail7']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail7']; ?> exists in the database. Please try again with another platform email 7.</li><?php } ?>
            <?php if ($data['page']['agent_edit']['error']['PlatformEmail8']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail8']; ?> exists in the database. Please try again with another platform email 8.</li><?php } ?>
            <?php if ($data['page']['agent_edit']['error']['PlatformEmail9']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail9']; ?> exists in the database. Please try again with another platform email 9.</li><?php } ?>
            <?php if ($data['page']['agent_edit']['error']['PlatformEmail10']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail10']; ?> exists in the database. Please try again with another platform email 10.</li><?php } ?>
            ...
            <?php if ($data['page']['agent_edit']['error']['Host']==1) { ?><li>The Host: <?php echo $data['form_param']['Host']; ?> was invalid.</li><?php } ?>
...
<form name="edit_form" class="admin_table_noMobile"  id="edit_form" action="<?php echo $data['config']['SITE_DIR']; ?>/agent/agent/editprocess/<?php echo $data['content'][0]['ID']; ?>" enctype="multipart/form-data" method="post">
 ...
 <option value="<?php echo $data['agent'][0]['ID']; ?>" <?php if($data['content'][0]['ParentID']==$data['agent'][0]['ID']){ ?> selected="selected" <?php } ?>><?php echo $data['agent'][0]['Name']; ?> - <?php echo $data['agent'][0]['ID']; ?></option>
