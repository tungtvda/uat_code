...
<?php /* ?>
    ...
    <div id="member_dashboard_box">
    	<div class="member_dashboard_box">
            ...
            <ul>
                <li><a href="<?php echo $data['config']['SITE_DIR']; ?>/agent/agent/dashboard">Dashboard</a></li>
                <!--<li><a href="<?php echo $data['config']['SITE_DIR']; ?>/member/reseller/profile">My Profile</a></li>-->
                <li><a href="<?php echo $data['config']['SITE_DIR']; ?>/agent/agent/password">Change Password</a></li>
            </ul>
        </div>
        <div class="member_dashboard_box">
            <h2>Members and Member Transactions</h2>
            <ul>
                <li><a href="<?php echo $data['config']['SITE_DIR']; ?>/agent/member/index">My Members</a></li>
                <li><a href="<?php echo $data['config']['SITE_DIR']; ?>/agent/member/group">My Group Members</a></li>
                <!--<li><a href="<?php echo $data['config']['SITE_DIR']; ?>/reseller/transaction/withdrawal">My Members' Wallet</a></li>-->
                <li><a href="<?php echo $data['config']['SITE_DIR']; ?>/agent/transaction/index">Member Transactions</a></li>
                <li><a href="<?php echo $data['config']['SITE_DIR']; ?>/agent/transaction/group">My Group Member Transactions</a></li> 
            </ul>
        </div>
        <!--<div class="member_dashboard_box">
    ...
    <ul>
    	<li><a href="<?php echo $data['config']['SITE_DIR']; ?>/agent/agentcredit/index">My Transactions</a></li>
        <li><a href="<?php echo $data['config']['SITE_DIR']; ?>/agent/agentcredit/group">My Agent Transactions</a></li>
    </ul>
</div>
    </div>
    <div class="clear"></div>
