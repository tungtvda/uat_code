<?php if ($data['page']['memberaddress_add']['error']['count']>0) { ?>
<?php } else { ?>
    <?php if ($data['page']['memberaddress_add']['ok']==1) { ?>
    <div class="notify">Member Address created successfully.</div>
    <?php } ?>
<?php } ?>
<?php if ($data['page']['memberaddress_edit']['error']['count']>0) { ?>
<?php } else { ?>
    <?php if ($data['page']['memberaddress_edit']['ok']==1) { ?>
