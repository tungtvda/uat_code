...
class App extends BaseController
{
	...
	protected function AddProcess()
	{
        ...
        else if ($this->section=='admin')
        {
			...
			{
				Helper::redirect($param['config']['SITE_DIR']."/admin/app/edit/".$param['content_param']['newID']);
			}
			else
			{
				Helper::redirect($param['config']['SITE_DIR']."/admin/app/add/");
			}
        }
        else if ($this->section=='api')
        {
	...
	protected function Edit()
	{
        ...
        else if ($this->section=='admin')
        {
	        ...
	        {
	            Helper::redirect($param['config']['SITE_DIR']."/admin/app/index");
	        }
        }
        else if ($this->section=='api')
        {
	...
	protected function EditProcess()
	{
        ...
        else if ($this->section=='admin')
        {
			...
			if ($param['status']['ok']=="1")
			{
				Helper::redirect($param['config']['SITE_DIR']."/admin/app/edit/".$this->id);
			}
			else
			{
				Helper::redirect($param['config']['SITE_DIR']."/admin/app/edit/".$this->id);
