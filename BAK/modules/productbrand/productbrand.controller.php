...
{
	protected $controller_name = "productbrand";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['productbrand_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/productbrand/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/productbrand/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_DIR']."/admin/productbrand/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['productbrand_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/productbrand/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/productbrand/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['productbrand_delete'] = $param['status'];
