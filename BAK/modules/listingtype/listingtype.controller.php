...
class ListingType extends BaseController 
{
	protected $controller_name = "listingtype";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['listingtype_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/listingtype/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/listingtype/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_URL']."/admin/listingtype/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['listingtype_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/listingtype/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/listingtype/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['listingtype_delete'] = $param['status'];
