<div id="dealer_login_wrapper">
  ...
  <form name="login_form" id="login_form" method="post" action="<?php echo $data['config']['SITE_URL']; ?>/dealer/dealer/loginprocess">
    <table border="0" cellspacing="0" cellpadding="0">
      ...
      <!-- <tr>
        <th scope="row">&nbsp;</th>
        <td class='subtext'><label><input type="checkbox" name="AutoLogin" value="1" <?php if (($data['page']['dealer_auth']==1)&&($_GET['autologin']==1)) { ?>checked="checked"<?php } ?> /> Keep me logged in</label></td>
      </tr> -->
      <tr>
        <th scope="row">&nbsp;</th>
        <td>&nbsp;</td>
      ...
      <tr>
        <th scope="row">&nbsp;</th>
        <td class='subtext'><div class="forgot_password"><a href="<?php echo $data['config']['SITE_URL']; ?>/dealer/dealer/forgotpassword">Forgot your password?</a></div></td>
      </tr>
    </table>
  </form>
</div>
