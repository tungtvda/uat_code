...
<form name="profileupgradeprocess_form" id="profileupgradeprocess_form_premier" action="<?php echo $data['config']['SITE_URL']; ?>/cart/order/confirm" method="post">
    <input type="hidden" name="OrderType" id="OrderType" value="Premier Membership" />
    <input type="hidden" name="OrderItem" id="OrderItem" value="Premier Membership Upgrade - One Year" />
