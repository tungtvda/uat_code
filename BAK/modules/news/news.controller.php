...
class News extends BaseController 
{
	...
	protected function AddProcess()
	{
		...
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/news/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/news/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_DIR']."/admin/news/index");
        }
	}
	...
	protected function EditProcess() 
	{
        ...
        $_SESSION['admin']['news_edit'] = $param['status'];
        
		if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/news/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/news/edit/".$this->id);
	...
	protected function Delete() 
	{
        ...
        $_SESSION['admin']['news_delete'] = $param['status'];
