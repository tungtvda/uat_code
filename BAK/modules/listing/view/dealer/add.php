<form action="<?php echo $data['config']['SITE_URL']; ?>/dealer/listing/addprocess" method="post" enctype="multipart/form-data" name="add_form" class="admin_table_nocell"  id="add_form">
  <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td><select name="MerchantID" class="chosen">
            ...
            <option value="<?php echo $data['content_param']['merchant_list'][$i]['ID']; ?>" <?php if($data['content_param']['merchant_list'][$i]['TypeID']!=1){ if ($data['content_param']['merchant_list'][$i]['ID']==$_SESSION['merchantdeal_DealerIndex']['param']['MerchantID']) { ?> selected="selected"<?php }}else{?>disabled="disabled"<?php } ?>><?php //echo $data['content_param']['merchant_list'][$i]['ID']; ?><?php echo $data['content_param']['merchant_list'][$i]['Name']; ?> - <?php echo $data['content_param']['merchant_list'][$i]['TypeLabel']; ?></option>
            <?php } ?>
          </select><span class="label_hint">(You only can select merchant(s) with type Premier or Standard)</span></td>
    </tr>
    <tr>
      ...
      <td><select name="TypeID" class="chosen">
            ...
            <option value="<?php echo $data['content_param']['listingtype_list'][$i]['ID']; ?>" <?php if ($data['content_param']['listingtype_list'][$i]['ID']==$_SESSION['listing_DealerIndex']['param']['TypeID']) { ?> selected="selected"<?php } ?>><?php //echo $data['content_param']['listingtype_list'][$i]['ID']; ?><?php echo $data['content_param']['listingtype_list'][$i]['Label']; ?></option>
            <?php } ?>
          </select></td>
    </tr>
    <tr>
