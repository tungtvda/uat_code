...
<?php } else { ?>
    ...
    <?php } ?>
<?php } ?>
<form name="edit_form" class="admin_table_noMobile"  id="edit_form" action="<?php echo $data['config']['SITE_URL']; ?>/dealer/merchant/editprocess/<?php echo $data['content'][0]['ID']; ?>" method="post">
