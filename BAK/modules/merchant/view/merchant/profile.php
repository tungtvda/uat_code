...
<form name="profile_form" class="admin_table_nocell"  id="profile_form" action="<?php echo $data['config']['SITE_URL']; ?>/merchant/merchant/profileprocess/" method="post">
  <table border="0" Mobilespacing="0" Mobilepadding="0">
    ...
    <tr>
      <th scope="row"><label>Account No</label></th>
      <td><input name="AccountNo" type="text" class="validate[required], custom[integer]" value="<?php echo (($data['form_param']['AccountNo']!="") ? $data['form_param']['AccountNo'] : $data['content'][0]['AccountNo']); ?>" size="20" maxlength="15" /><span class="label_hint">(e.g. 932009137)</span></td>
    </tr>
    <tr>
      <th scope="row"><label>Bank Name</label></th>
      <td><input name="Bank" type="text" class="validate[required]]" value="<?php echo (($data['form_param']['Bank']!="") ? $data['form_param']['Bank'] : $data['content'][0]['Bank']); ?>" size="20" maxlength="15" /><span class="label_hint">(e.g. CIMB)</span></td>
    </tr>
    <tr>
