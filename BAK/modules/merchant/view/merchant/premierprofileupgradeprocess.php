...
<form name="profileupgradeprocess_form" id="profileupgradeprocess_form_premier" action="<?php echo $data['config']['SITE_URL']; ?>/cart/order/confirm/<?php echo $_SESSION['dealer']['ID'] ?>" method="post">
