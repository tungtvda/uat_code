  ...
  <table>
    <tbody>
      ...
      <tr>
        ...
        To protect your account, please login to your account immediately at <a style="color:#007CF9;" href="<?php echo $param['config']['SITE_URL']; ?><?php echo $param['config']['SITE_URL']; ?>"><?php echo $param['config']['SITE_URL']; ?><?php echo $param['config']['SITE_URL']; ?></a> and change your password. Thank you.</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
