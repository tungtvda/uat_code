...
{
	protected $controller_name = "productimage";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['productimage_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/productimage/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/productimage/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_DIR']."/admin/productimage/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['productimage_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/productimage/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/productimage/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['productimage_delete'] = $param['status'];
