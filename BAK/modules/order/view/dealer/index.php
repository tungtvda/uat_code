...
<table class="member_table" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <th style="white-space:nowrap; text-align: center">Merchant</th>
    <th>Item</th>
    <th class="center">Payment Method</th>
    <th class="text_right">Total (RM)</th>
    <th class="text_right">Dealer Total (RM)</th>
    <th class="text_right">Dealer Discount (%)</th>
    <th class="center">Status</th>
    <th class="center">Download</th>
  </tr>
  <?php for ($i=0; $i<$data['content_param']['count']; $i++) { ?>
  <tr>
    <td style="white-space:nowrap; text-align: center"><?php echo $data['content'][$i]['MerchantID']; ?></td>
    <td>
    ...
    <td class="text_right"><?php echo $data['content'][$i]['DealerTotal']; ?></td>
    <td class="text_right"><?php echo $data['content'][$i]['DealerDiscount']; ?></td>
    <td class="center"><?php echo $data['content'][$i]['Status']['Label']; ?></td>
    <td class="center"><a href="<?php echo $data['config']['SITE_URL']; ?>/dealer/order/export/<?php echo $data['content'][$i]['ID']; ?>">Download Order</a></td>
  </tr>
  <?php } ?>
</table>
<?php } else { ?>
