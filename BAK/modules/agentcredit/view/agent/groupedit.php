...
<?php } else { ?>
    ...
    <?php } ?>
<?php } ?>
<form name="edit_form" class="admin_table_nocell"  id="edit_form" action="<?php echo $data['config']['SITE_DIR']; ?>/agent/agentcredit/groupeditprocess/<?php echo $data['content'][0]['ID']; ?>" method="post">
