	    ...
	    <table border="0" cellspacing="0" cellpadding="0" style="width:100%">
	      <tr>	        
            ...
            <td><select name="AgentID" class="chosen_full">
                ...
                <option value="<?php echo $data['agent'][0]['ID']; ?>" <?php if($_SESSION['agentcredit_AgentGroup']['param']['AgentID']==$data['agent'][0]['ID']){ ?>selected="selected"<?php } ?>><?php echo $data['agent'][0]['Name']; ?> - <?php echo $data['agent'][0]['ID']; ?></option>
