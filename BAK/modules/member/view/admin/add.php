  ...
  <table border="0" Mobilespacing="0" Mobilepadding="0">
    <tr>
      ...
      <td><select name="Agent" class="chosen_simple">
          ...
          <option value="<?php echo $data['content_param']['agent_list'][$i]['ID']; ?>" <?php if ($data['content_param']['agent_list'][$i]['ID']==$data['form_param']['agent_list']) { ?>selected="selected"<?php } ?>><?php echo $data['content_param']['agent_list'][$i]['Name']; ?></option>
          <?php } ?>
        </select></td>
    </tr>
    <tr>
...
<!--<tr>
    ...
    <tr>
      ...
      <td>
          <select name="Bank" class="validate[required] chosen="<?php echo $data['form_param']['Bank']; ?>">
