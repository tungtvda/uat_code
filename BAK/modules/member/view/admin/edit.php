...
<?php } else { ?>
    ...
    <?php } ?>
<?php } ?>
<form name="edit_form" class="admin_table_noMobile"  id="edit_form" action="<?php echo $data['config']['SITE_DIR']; ?>/admin/member/editprocess/<?php echo $data['content'][0]['ID']; ?>" method="post">
    ...
    <tr>
      ...
      <td><select name="Agent" class="chosen_simple">
          ...
          <option value="<?php echo $data['content_param']['agent_list'][$i]['ID']; ?>"
              ...
              <?php } ?>><?php echo $data['content_param']['agent_list'][$i]['Name']; ?></option>
          <?php } ?>
        </select></td>
    </tr>
    <tr>
...
<!--<tr>
    ...
    <tr>
      ...
      <td>
          <select name="Bank" class="validate[] chosen">
                        ...
                        <option value="<?php echo $data['content_param']['bank_list'][$i]['Label']; ?>"disabled <?php if($data['content'][$i]['Bank']==$data['content_param']['bank_list'][$i]['Label']){ ?> selected="selected" <?php } ?>><?php echo $data['content_param']['bank_list'][$i]['Label']; ?></option>
                        <?php } ?>
                  </select>
          </td>
    </tr>
    <tr>
      ...
      <td><input name="BankAccountNo" type="text" disabled="true" class="validate[required, custom[integer], minsize[2]]" value="<?php echo (($data['form_param']['BankAccountNo']!="") ? $data['form_param']['BankAccountNo'] : $data['content'][0]['BankAccountNo']); ?>" size="40" /></td>
    </tr>
    <?php } ?>
<!--<tr>
