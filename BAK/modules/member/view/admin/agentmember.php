...
<a href="<?php echo $data['config']['SITE_URL'].$data['config']['SITE_DIR']; ?>/admin/agent/agentlist/<?php echo $data['paramParent']; ?>">
...
<!--    <td><div align="center">
    <a href="<?php echo $data['config']['SITE_DIR']; ?>/admin/wallet/view/<?php echo $data['content'][$i]['ID']; ?>">View
    </a></div>
    </td>-->
  </tr>
  <?php } ?>
