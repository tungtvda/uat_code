  ...
  <table border="0" Mobilespacing="0" Mobilepadding="0">
    <tr>
      ...
      <td><select name="Agent" class="validate[] chosen">
                        <option value="<?php echo $data['agent'][0]['ID']; ?>"<?php if($data['content'][0]['Agent']==$data['agent'][0]['ID']){ ?> selected="selected"<?php } ?>><?php echo $data['agent'][0]['Name']; ?> - <?php echo $data['agent'][0]['ID']; ?></option><?php familyTree($data['agent'][0]['Child'], $data['content'][0]['Agent']); ?>
          </select>
          </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
          <select name="Bank" class="validate[] chosen">
                        ...
                        <option value="<?php echo $data['content_param']['bank_list'][$i]['Label']; ?>"disabled <?php if($data['content'][0]['Bank']==$data['content_param']['bank_list'][$i]['Label'] ){ ?> selected="selected" <?php } ?>><?php echo $data['content_param']['bank_list'][$i]['Label']; ?></option>
                        <?php } ?>
                  </select>
    ...
    <tr>
      ...
      <td><input name="BankAccountNo" type="text" disabled="disabled"  class="validate[required, custom[integer], minsize[2]]" value="<?php echo (($data['form_param']['BankAccountNo']!="") ? $data['form_param']['BankAccountNo'] : $data['content'][0]['BankAccountNo']); ?>" size="40" /></td>
    </tr>
    <?php } ?>
    <tr>
