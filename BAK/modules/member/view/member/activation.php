...
<div id="member_login_wrapper">
	 <form id="activation_form" name="activation_form" class="common_block common_form" method="post" action="<?php echo $data['config']['SITE_DIR']; ?>/member/member/activationprocess">
  ...
  <br />
  <hr />
	<form id="resend_form" name="resend_form" class="common_block common_form" method="post" action="<?php echo $data['config']['SITE_DIR']; ?>/member/member/resendactivationprocess">
  ...
  <br />
  <?php } else { ?>
  	<form id="mobile_form" name="mobile_form" class="common_block common_form" method="post" action="<?php echo $data['config']['SITE_DIR']; ?>/member/member/updateactivationprocess">
