		...
		<div class="small-12 medium-12 large-12 end columns">
		    <form id="add_form" name="add_form" class="common_block common_form" method="post" action="<?php echo $data['config']['SITE_DIR']; ?>/member/member/registerprocess">
			    ...
			    <div class="row">
			    	...
			    	<div class="small-12 medium-12 large-9 columns">
			    	    <?php echo Helper::translate("(E.g. 2255667. Compulsory for SMS verification)", "member-register-mobileno-note"); ?><br />
			    ...
			    <div class="row">
			    	...
			    	<div class="small-12 medium-12 large-9 columns">
			    		<input type="text" class="validate[required,custom[email]]" name="Email" id="Email" placeholder="(e.g. your.name@domain.com)" value="<?php echo $data['form_param']['Email']; ?>" />
			    	</div>
		    	</div>
		    	<hr />
                <div class="row">
