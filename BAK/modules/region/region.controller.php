...
{
	protected $controller_name = "region";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['region_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/region/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/region/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_URL']."/admin/region/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['region_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/region/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/region/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['region_delete'] = $param['status'];
