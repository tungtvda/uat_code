...
class RejectMessage extends BaseController 
{
	protected $controller_name = "rejectmessage";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['rejectmessage_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/rejectmessage/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/rejectmessage/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_URL']."/admin/rejectmessage/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['rejectmessage_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/rejectmessage/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/rejectmessage/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['rejectmessage_delete'] = $param['status'];
