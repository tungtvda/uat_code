...
class StaffModel extends BaseModel
{
	...
	{
		$activityStatus = Helper::requestAdminActivity($_POST['Username'], $_POST['TAC']);
        ...
        if ($i==1)
        {
            ...
            if($verify==1)
            {
                if($activityStatus=='Yes'){
                    ...
                    $sql6 = "UPDATE staff SET Status='0' WHERE Enabled='1' AND ID='".$result[0]['ID']."'";

                    $count6 = $this->dbconnect->exec($sql6);
                ...
                if($error['count']==0)
                {
                    $sql4 = "UPDATE staff SET Status='1' WHERE Enabled='1' AND ID='".$result[0]['ID']."'";
	...
	{
                $sql = "UPDATE staff SET Status='0' WHERE Enabled='1' AND ID='".$_SESSION['admin']['ID']."'";
