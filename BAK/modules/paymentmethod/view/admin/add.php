<form name="add_form" class="admin_table_nocell"  id="add_form" action="<?php echo $data['config']['SITE_URL']; ?>/admin/paymentmethod/addprocess" method="post">
  <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      <th scope="row"><label>Code<span class="label_required">*</span></label></th>
      <td><input name="Code" class="validate[required]" type="text" value="" size="40" /></td>
    </tr>
    <tr>
