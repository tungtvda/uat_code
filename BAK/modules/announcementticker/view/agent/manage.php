	    ...
	    <table border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td>
                    ...
                    <option value="<?php echo $data['agent'][0]['ID']; ?>" <?php if($data['agent'][0]['ID']==$_SESSION['announcementticker_AgentManage']['param']['Agent']){ ?>selected="selected"<?php } ?>><?php echo $data['agent'][0]['Name']; ?> - <?php echo $data['agent'][0]['ID']; ?></option>
