<div id="search_box"<?php if ($data['content_param']['search']=="off") { ?>class="search_initial"<?php } ?>>
  ...
  <div id="search_content" <?php if ($data['content_param']['search']=="off") { ?>class="invisible"<?php } ?>>
	  ...
	  <form name="search_form" class="admin_table_nocell"  id="search_form" action="<?php echo $data['config']['SITE_DIR']; ?>/admin/announcementticker/manage" method="post">
	    ...
	    <table border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td>
                    ...
                    <option value="<?php echo $data['content_param']['test1'][$g]['ID']; ?>" <?php if($data['content_param']['test1'][$g]['ID']==$_SESSION['announcementticker_AdminManage']['param']['Agent']){ ?>selected="selected"<?php } ?>><?php echo $data['content_param']['test1'][$g]['Name']; ?> - <?php echo $data['content_param']['test1'][$g]['ID']; ?></option>
	            <?php Helper::agentOptionList($data['content_param']['test1'][$g]['Child'], $_SESSION['announcementticker_AdminManage']['param']['Agent']); ?>
                    <?php } ?>
                    <?php for ($i=0; $i<$data['content_param']['test2']['count']; $i++) { ?>
	            <option value="<?php echo $data['content_param']['test2'][$i]['ID']; ?>" <?php if ($data['content_param']['test2'][$i]['ID']==$_SESSION['announcementticker_AdminManage']['param']['Agent']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['test2'][$i]['Name']; ?></option>
	            <?php } ?>
                    </select>
                </td>
	        <td>&nbsp;</td>
	      ...
	      <tr>
	        ...
	        <td class="text_right"><input type="submit" name="submit" value="Search" class="button" />
	          <a href="<?php echo $data['config']['SITE_DIR']; ?>/admin/announcementticker/manage?page=all">
...
<div class="admin_results">
  ...
  <div class="results_right"><a href='/admin/announcementticker/index?page=all'>
