...
<?php } else { ?>
    ...
    <div class="notify">Ad created successfully.</div>
    <?php } ?>
<?php } ?>
...
<?php } else { ?>
    ...
    <div class="notify">Ad edited successfully.</div>
    <?php } ?>
<?php } ?>
<form action="<?php echo $data['config']['SITE_URL']; ?>/dealer/ad/editprocess/<?php echo $data['content'][0]['ID']; ?>" method="post" enctype="multipart/form-data" name="edit_form" class="admin_table_nocell"  id="edit_form">
