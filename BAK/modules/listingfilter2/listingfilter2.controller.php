...
class ListingFilterTwo extends BaseController 
{
	protected $controller_name = "listingfiltertwo";
	...
	protected function Start()
	{
		...
		$model = new ListingFilterTwoModel();
		return $model;
	}
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['listingfiltertwo_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/listingfiltertwo/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/listingfiltertwo/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_URL']."/admin/listingfiltertwo/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['listingfiltertwo_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/listingfiltertwo/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/listingfiltertwo/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['listingfiltertwo_delete'] = $param['status'];
