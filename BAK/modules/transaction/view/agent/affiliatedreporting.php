...
<?php for ($i = 0; $i < $data['content']['count']; $i++) { ?> 
 <tr class="color">
      <td class="center"><a href="<?php echo $data['config']['SITE_URL'].$data['config']['SITE_DIR']; ?>/agent/transaction/affiliatedreporting/<?php echo $data['content'][$i]['ID'];  ?>"><?php echo $data['content'][$i]['Name']; ?></a></td>
