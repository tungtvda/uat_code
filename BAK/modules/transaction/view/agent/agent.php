	    ...
	    <table border="0" cellspacing="0" cellpadding="0" style="width:100%">
	      ...
	      <tr>
            ...
            <td><select name="MemberID" class="chosen">
                ...
                <option value="<?php echo $data['content_param']['member_list'][$i]['ID']; ?>" <?php if ($data['content_param']['member_list'][$i]['ID']==$_SESSION['transaction_AgentAgent']['param']['t.MemberID']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['member_list'][$i]['Name']; ?> | <?php echo $data['content_param']['member_list'][$i]['Username']; ?></option>
                <?php } ?>
              </select>
            </td>
            <td>&nbsp;</td>
