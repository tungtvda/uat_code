...
<?php } else { ?>
    ...
    <?php } ?>
<?php } ?>
<form name="edit_form" class="admin_table_nocell"  id="edit_form" action="<?php echo $data['config']['SITE_DIR']; ?>/admin/transaction/editprocess/<?php echo $data['content'][0]['ID']; ?>" method="post">
  <table border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td><select name="MemberID" class="chosen">
          ...
          <option value="<?php echo $data['content_param']['member_list'][$i]['ID']; ?>" <?php if ($data['content_param']['member_list'][$i]['ID']==$data['content'][0]['MemberID']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['member_list'][$i]['Name']; ?> | <?php echo $data['content_param']['member_list'][$i]['Username']; ?></option>
          <?php } ?>
        </select></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
          <select name="Promotion" class="validate[] chosen_full">
                        ...
                        <option value="<?php echo $data['content_param']['agentpromotion_list'][$i]['Title']; ?>" <?php if ($data['content_param']['agentpromotion_list'][$i]['Title']==$data['content'][0]['Promotion']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['agentpromotion_list'][$i]['Title']; ?></option>
                        <?php } ?>
                    </select>
      </td>
    </tr>
    ...
    <?php if($_SESSION['agent']['operator']['ProfileID']!='2'){ ?>
    <tr>
      <th scope="row"><label>In (MYR)</label></th>
      <td><input name="Debit" type="text" readonly="true" class="validate[custom[number]]" value="<?php echo $data['content'][0]['In']; ?>" size="10" /></td>
    </tr>
    <tr>
      <th scope="row"><label>Out (MYR)</label></th>
      <td><input name="Credit" type="text" readonly="true" class="validate[custom[number]]" value="<?php echo $data['content'][0]['Out']; ?>" size="10" /></td>
    </tr>
    <tr>
      <th scope="row"><label>Transfer (MYR)</label></th>
      <td><input name="Amount" type="text" readonly="true" class="validate[custom[number]]" value="<?php echo $data['content'][0]['Amount']; ?>" size="10" /></td>
    </tr>
    <?php }?>
   <!--<tr>
    ...
    <tr>
      ...
      <td><input type="submit" name="submit" value="Update" class="button" />
        <a href="<?php echo $data['config']['SITE_DIR']; ?>/admin/transaction/index">
