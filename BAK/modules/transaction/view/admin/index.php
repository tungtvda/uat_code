...
<!--    <th>&nbsp;</th>-->
  ...
  <tr>
    ...
    <td> <?php if ($data['content'][$i]['TypeID']=='Deposit') { ?>
       ...
       <?php echo $data['content'][$i]['Description']; ?></a><?php echo $data['content'][$i]['Date']; ?>
        <?php } ?>
    </td>
  ...
  <td class="center"><?php if($data['content'][$i]['Status'] == 'Rejected'){ ?><?php echo '<span class ="error">'.$data['content'][$i]['Status'].'</span>'; ?><?php }else{ echo $data['content'][$i]['Status']; } ?></td>
    ...
    <?php } else { ?>
        ...
        <td class="center"><?php if (($data['content'][$i]['StaffID']!="")&&($data['content'][$i]['StaffID']!="0")) { ?>
        <div style="margin-top:5px; font-size:11px; font-style:italic; color: #777;">Last Updated: <?php echo $data['content'][$i]['UpdatedDate']; ?> <?php echo $data['content'][$i]['StaffIDUpdated'][0]['Email']; ?></div><?php } ?></td>
