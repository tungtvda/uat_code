...
<div style="margin-bottom:15px;">
    <form name="reseller_form" class="admin_table_nocell" id="reseller_form">
        Agent:
        <select name="Agent_ID" class="chosen" id="Agent_ID">
            <option value="">- Select agent -</option>
            <?php for ($i=0; $i<$data['content_param']['agent_list']['count']; $i++) { ?>
            <option value="/admin/transaction/agent/<?php echo $data['content_param']['agent_list'][$i]['ID']; ?>?page=all" <?php if ($data['content_param']['agent_list'][$i]['ID']==$_GET['id']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['agent_list'][$i]['Name']; ?> (<?php echo $data['content_param']['agent_list'][$i]['Company']; ?>)</option>
            <?php } ?>
        </select>
    </form>
</div>
	    ...
	    <table border="0" cellspacing="0" cellpadding="0" style="width:100%">
	      ...
	      <tr>
            ...
            <td><select name="MemberID" class="chosen">
                ...
                <option value="<?php echo $data['content_param']['member_list'][$i]['ID']; ?>" <?php if ($data['content_param']['member_list'][$i]['ID']==$_SESSION['transaction_AdminAgent']['param']['t.MemberID']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['member_list'][$i]['Name']; ?> | <?php echo $data['content_param']['member_list'][$i]['Username']; ?></option>
                <?php } ?>
              </select>
            </td>
            <td>&nbsp;</td>
