<div id="search_box"<?php if ($data['content_param']['search']=="off") { ?>class="search_initial"<?php } ?>>
  ...
  <div id="search_content" <?php if ($data['content_param']['search']=="off") { ?>class="invisible"<?php } ?>>
	  ...
	  <form name="search_form" class="admin_table_nocell"  id="search_form" action="<?php echo $data['config']['SITE_DIR']; ?>/admin/transaction/affiliatedreporting/<?php echo $data['param']; ?>" method="post">
	    ...
	    <table border="0" cellspacing="0" cellpadding="0">
	      ...
	      <tr>
	        ...
	        <td><input name="DateFrom" class="validate[custom[dmyDateTime]] datepicker" type="text" value="<?php echo $_SESSION['AdminAffiliatedReporting']['DateFrom']; ?>" size="20" />
	          (dd-mm-yyyy hh:mm:ss)</td>
	        <td>&nbsp;</td>
                <th scope="row"><label>Date (To)</label></th>
	        <td><input name="DateTo" class="validate[custom[dmyDateTime]] defaultdatepicker" type="text" value="<?php echo $_SESSION['AdminAffiliatedReporting']['DateTo']; ?>" size="20" />
	          (dd-mm-yyyy hh:mm:ss)</td>
	      </tr>	      
	      <tr>
	        ...
	        <td class="text_right"><input type="submit" name="submit" value="Search" class="button" />
	          <a href="<?php echo $data['config']['SITE_DIR']; ?>/admin/transaction/affiliatedreporting?page=all">
...
<a href="<?php echo $data['config']['SITE_URL'].$data['config']['SITE_DIR']; ?>/admin/transaction/affiliatedreporting/<?php echo $data['parentID']; ?>">
    &laquo;Back To Parent
</a>
<br>&nbsp;
<?php }elseif($data['parentID']=='0'){ ?>
<a href="<?php echo $data['config']['SITE_URL'].$data['config']['SITE_DIR']; ?>/admin/transaction/affiliatedreporting">
    &laquo;Back To Parent
</a>
<br>&nbsp;
<?php } ?>
<?php //if ($data['content_param']['count']>'0') { ?>
 <table class="admin_table" border="0" cellpadding="0" cellspacing="0" style = "width:100%;">
 <tr class="noBorder">
    <th class="center"></th>
 ...
 <tr class="color">
     <td class="center" id="agentName"><?php echo $data['currentAgent'][0]['Name']; ?></td>
...
<?php for ($i = 0; $i < $data['content']['count']; $i++) { ?> 
  <tr class="color">
      <td class="center"><a href="<?php echo $data['config']['SITE_URL'].$data['config']['SITE_DIR']; ?>/admin/transaction/affiliatedreporting/<?php echo $data['content'][$i]['ID'];  ?>"><?php echo $data['content'][$i]['Name']; ?></a></td>
    ...
    <td class="text_right rightBorder"><?php echo ($data['content'][$i]['First']['Profitsharing']=='')? '0.00':$data['content'][$i]['First']['Profitsharing']; ?></td>
...
<tr class="noBorder">
    ...
    <th class="text_right"></th>
    <th class="text_right"></th>
    <th class="text_right">Yourself (100%)</th>
    <th class="text_right"></th>
    <th class="text_right"></th>
    <th class="text_right">Upline (0%)</th>
    <th class="text_right"></th>
 </tr>
 <tr>
    ...
    <th class="text_right">Total (RM)</th>
        ...
        <?php for ($i = 0; $i < $data['currentAgent']['count']; $i++) { ?> 
 
 <tr class="color">
     <td class="center"><a href="<?php echo $data['config']['SITE_URL'].$data['config']['SITE_DIR']; ?>/admin/transaction/affiliatedreporting/<?php echo $data['currentAgent'][$i]['ID'];  ?>"><?php echo $data['currentAgent'][$i]['Name']; ?></a></td>
    <td class="text_right leftBorder"><?php echo ($data['currentAgent'][$i]['First']['In']=='')? '0.00':Helper::displayCurrency($data['currentAgent'][$i]['First']['In']); ?></td>
    <td class="text_right"><?php echo ($data['currentAgent'][$i]['First']['Out']=='')? '0.00':Helper::displayCurrency($data['currentAgent'][$i]['First']['Out']); ?></td>
    <td class="text_right"><?php echo ($data['currentAgent'][$i]['First']['winLose']=='')? '0.00':Helper::displayCurrency($data['currentAgent'][$i]['First']['winLose']); ?></td>
    <td class="text_right color"><?php echo ($data['currentAgent'][$i]['First']['Bonus']=='')? '0.00':'-'.Helper::displayCurrency($data['currentAgent'][$i]['First']['Bonus']); ?></td>
    <td class="text_right"><?php echo ($data['currentAgent'][$i]['First']['Profit']=='')? '0.00':Helper::displayCurrency($data['currentAgent'][$i]['First']['Profit']); ?></td>
    <td class="text_right rightBorder"><?php echo ($data['currentAgent'][$i]['First']['Profitsharing']=='')? '0.00':$data['currentAgent'][$i]['First']['Profitsharing']; ?></td>
    <td class="text_right"><?php echo ($data['currentAgent'][$i]['Sec']['In']=='')? '0.00':Helper::displayCurrency($data['currentAgent'][$i]['Sec']['In']); ?></td>
    <td class="text_right color"><?php echo ($data['currentAgent'][$i]['Sec']['Bonus']=='')? '0.00':'-'.Helper::displayCurrency($data['currentAgent'][$i]['Sec']['Bonus']); ?></td>
    <td class="text_right rightBorder"><?php echo ($data['currentAgent'][$i]['Sec']['Profit']=='')? '0.00':Helper::displayCurrency($data['currentAgent'][$i]['Sec']['Profit']); ?></td>
    <td class="text_right"><?php echo ($data['currentAgent'][$i]['Third']['In']=='')? '0.00':Helper::displayCurrency($data['currentAgent'][$i]['Third']['In']); ?></td>
    <td class="text_right color"><?php echo ($data['currentAgent'][$i]['Third']['Bonus']=='')? '0.00':'-'.Helper::displayCurrency($data['currentAgent'][$i]['Third']['Bonus']); ?></td>
    <td class="text_right rightBorder"><?php echo ($data['currentAgent'][$i]['Third']['Profit']=='')? '0.00':Helper::displayCurrency($data['currentAgent'][$i]['Third']['Profit']); ?></td>
    <td class="text_right"><?php echo ($data['currentAgent'][$i]['Fourth']['In']=='')? '0.00':Helper::displayCurrency($data['currentAgent'][$i]['Fourth']['In']); ?></td>
    <td class="text_right color"><?php echo ($data['currentAgent'][$i]['Fourth']['Bonus']=='')? '0.00':'-'.Helper::displayCurrency($data['currentAgent'][$i]['Fourth']['Bonus']); ?></td>
    <td class="text_right rightBorder"><?php echo ($data['currentAgent'][$i]['Fourth']['Profit']=='')? '0.00':Helper::displayCurrency($data['currentAgent'][$i]['Fourth']['Profit']); ?></td>
 </tr>
