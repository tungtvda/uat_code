<?php if ($data['page']['dealeraddress_add']==1) { ?>
<div class="notify">Dealer Address created successfully.</div>
<?php } ?>
<?php if ($data['page']['dealeraddress_edit']==1) { ?>
<div class="notify">Dealer Address edited successfully.</div>
<?php } ?>
<?php if ($data['page']['dealeraddress_edit']==2) { ?>
<div class="notify">Dealer Address edited, but no changes were made.</div>
<?php } ?>
<form name="edit_form" class="admin_table_nocell"  id="edit_form" action="<?php echo $data['config']['SITE_URL']; ?>/admin/dealeraddress/editprocess/<?php echo $data['content'][0]['ID']; ?>" method="post">
  <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td><select name="DealerID" class="chosen_simple">
          ...
          <option value="<?php echo $data['content_param']['dealer_list'][$i]['ID']; ?>" <?php if ($data['content_param']['dealer_list'][$i]['ID']==$data['content'][0]['DealerID']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['dealer_list'][$i]['FirstName']; ?></option>
          <?php } ?>
        </select></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="submit" name="submit" value="Update" class="button" />
        <a href="<?php echo $data['config']['SITE_URL']; ?>/admin/dealeraddress/index">
