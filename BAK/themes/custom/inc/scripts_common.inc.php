...
<link href='//fonts.googleapis.com/css?family=Open+Sans:400,700,300,300italic,400italic,600,600italic,800,700italic,800italic' rel='stylesheet' type='text/css'>
<link href="//maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" href="<?php echo $data['config']['THEME_DIR']; ?>css/foundation/foundation.min.css">
<link rel="stylesheet" href="<?php echo $data['config']['THEME_DIR']; ?>css/foundation/normalize.css">
<link rel="stylesheet" href="<?php echo $data['config']['THEME_DIR']; ?>css/app.css?<?php echo time(); ?>" />
<!-- Validation Engine -->
...
<style>
    ...
    #overriden_member_in_box {
	display: block;
	margin: 1rem 0;
    }
    #overriden_member_in_box a{  
