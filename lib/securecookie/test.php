...
$C = new SecureCookie('mysecretword','SampleCookie',time()+5184000,'/','',true);
...
$C2 = new SecureCookie('mysecretwordx','SampleCookie',time()+3600,'/','');
...
'</pre><br /><br /><b>Actual Cookie:</b><br><pre>'.$_COOKIE['SampleCookie'].'</pre><br /><br />';