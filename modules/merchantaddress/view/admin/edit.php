<?php if ($data['page']['merchantaddress_add']['error']['count']>0) { ?>
<?php } else { ?>
    <?php if ($data['page']['merchantaddress_add']['ok']==1) { ?>
    <div class="notify">Merchant Address created successfully.</div>
    <?php } ?>
<?php } ?>
<?php if ($data['page']['merchantaddress_edit']['error']['count']>0) { ?>
<?php } else { ?>
    <?php if ($data['page']['merchantaddress_edit']['ok']==1) { ?>
