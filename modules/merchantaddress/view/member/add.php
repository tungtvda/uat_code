<?php if ($data['page']['merchantaddress_add']==2) { ?>
<div class="error">Merchant Address could not be created. Please try again.</div>
<?php } ?>
  ...
  <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td><select name="MerchantID" class="chosen_simple">
            ...
            <option value="<?php echo $data['content_param']['merchant_list'][$i]['ID']; ?>"><?php echo $data['content_param']['merchant_list'][$i]['FirstName']; ?></option>
            <?php } ?>
          </select></td>
    </tr>
    <tr>
