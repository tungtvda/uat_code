...
class Tax extends BaseController 
{
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['tax_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/tax/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/tax/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_URL']."/admin/tax/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['tax_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/tax/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/tax/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['tax_delete'] = $param['status'];
