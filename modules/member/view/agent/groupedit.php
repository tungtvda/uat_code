...
<?php } else { ?>
    ...
    <?php } ?>
<?php } ?>
<form name="edit_form" class="admin_table_noMobile"  id="edit_form" action="<?php echo $data['config']['SITE_DIR']; ?>/agent/member/groupeditprocess/<?php echo $data['content'][0]['ID']; ?>" method="post">
  <table border="0" Mobilespacing="0" Mobilepadding="0">
    <tr>
      ...
      <td><select name="Agent" class="chosen_simple">
          ...
          <option value="<?php echo $data['content_param']['agent_list'][$i]['ID']; ?>"
              <?php if ($data['form_param']['Agent']!="") { ?>
              <?php if ($data['content_param']['agent_list'][$i]['ID']==$data['form_param']['Agent']) { ?>selected="selected"<?php } ?>
              <?php } else { ?>
              <?php if ($data['content_param']['agent_list'][$i]['ID']==$data['content'][0]['Agent']) { ?>selected="selected"<?php } ?>
              <?php } ?>><?php echo $data['content_param']['agent_list'][$i]['Name']; ?> - <?php echo $data['content_param']['agent_list'][$i]['ID']; ?> | <?php echo $data['content_param']['agent_list'][$i]['Company']; ?></option>
          <?php } ?>
        </select></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
          <select name="Bank" class="validate[] chosen">
                        ...
                        <option value="<?php echo $data['content_param']['bank_list'][$i]['Label']; ?>" <?php if($data['content'][$i]['Bank']==$data['content_param']['bank_list'][$i]['Label']){ ?> selected="selected" <?php } ?>><?php echo $data['content_param']['bank_list'][$i]['Label']; ?></option>
                        <?php } ?>
                  </select>
          </td>
    </tr>
    <tr>
      ...
      <td><input name="BankAccountNo" type="text" class="validate[required, custom[integer], minsize[2]]" value="<?php echo (($data['form_param']['BankAccountNo']!="") ? $data['form_param']['BankAccountNo'] : $data['content'][0]['BankAccountNo']); ?>" size="40" /></td>
    </tr>
    <tr>
