...
<div style="width: 550px; border:1px solid #ddd; padding:15px 20px 20px; margin:10px; border-radius:6px; background-color: #fff; font-family:Arial,sans-serif; font-size:12px; color:#333;">
  <table>
    <tbody>
      ...
      <tr>
        <td align="left"><?php echo Helper::translate("Hi", "member-mail-forgotpassword-hi"); ?> <strong style="color:#c00;"><?php echo $param['content'][0]['Name']; ?></strong>,<br /><br /><?php echo Helper::translate("We have received your request for a new password:", "member-mail-forgotpassword-message-1"); ?><br /><br />
        <b><?php echo Helper::translate("Username:", "member-mail-forgotpassword-username"); ?></b> <?php echo $param['content'][0]['Username']; ?><br />
        <b><?php echo Helper::translate("Password:", "member-mail-forgotpassword-password"); ?></b> <?php echo $param['content_param']['new_password']; ?><br /><br />
