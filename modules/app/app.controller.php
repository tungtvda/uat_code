...
class App extends BaseController
{
	...
	protected function AddProcess()
	{
        ...
        {
			$_SESSION['admin']['app_add'] = $param['status'];
	
			if ($param['status']['ok']=="1")
			{
				Helper::redirect($param['config']['SITE_URL']."/admin/app/edit/".$param['content_param']['newID']);
			}
			else
			{
				Helper::redirect($param['config']['SITE_URL']."/admin/app/add/");
			}
        }
        else if ($this->section=='api')
        {
	...
	protected function Edit()
	{
        ...
        else if ($this->section=='admin')
        {
	        ...
	        {
	            Helper::redirect($param['config']['SITE_URL']."/admin/app/index");
	        }
        }
        else if ($this->section=='api')
        {
	...
	protected function EditProcess()
	{
        ...
        {
	        $_SESSION['admin']['app_edit'] = $param['status'];
	
			if ($param['status']['ok']=="1")
			{
				Helper::redirect($param['config']['SITE_URL']."/admin/app/edit/".$this->id);
			}
			else
			{
				Helper::redirect($param['config']['SITE_URL']."/admin/app/edit/".$this->id);
	...
	protected function Delete()
	{
        ...
        {
	        $_SESSION['admin']['app_delete'] = $param['status'];
