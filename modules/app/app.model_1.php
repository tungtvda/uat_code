...
class AppModel extends BaseModel
{
	...
	public function Index($param)
	{
		...
		$targetpage = $data['config']['SITE_DIR'].'/main/app/index';
		$limit = 5;
		$stages = 3;
	...
	public function AdminIndex($param)
	{
		...
		$targetpage = $data['config']['SITE_DIR'].'/admin/app/index';
		$limit = 10;
		$stages = 3;
		$page = mysql_escape_string($_GET['page']);
		if ($page) {
	...
	public function AdminAdd($param)
	{
        // Set breadcrumb
        $breadcrumb = array(
            array("Title" => $this->module['app']['name'], "Link" => $this->module['app']['admin_url']),
            array("Title" => "Create App", "Link" => "")
        );
