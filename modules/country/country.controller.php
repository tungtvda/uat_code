...
{
	protected $controller_name = "country";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['country_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/country/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/country/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_DIR']."/admin/country/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['country_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/country/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/country/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['country_delete'] = $param['status'];
