<form name="add_form" class="admin_table_nocell"  id="add_form" action="<?php echo $data['config']['SITE_DIR']; ?>/admin/template/addprocess" method="post">
  <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td><select name="ThemeID" class="chosen">
            ...
            <option value="<?php echo $data['content_param']['theme_list'][$i]['ID']; ?>"><?php echo $data['content_param']['theme_list'][$i]['Name']; ?></option>
            <?php } ?>
          </select></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="Filename" class="validate[required]" type="text" value="" size="40" /></td>
    </tr>
    <tr>
