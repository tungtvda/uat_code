<div id="member_login_wrapper">
  ...
  <form name="login_form" id="login_form" method="post" action="<?php echo $data['config']['SITE_DIR']; ?>/agent/agent/loginprocess">
    <table border="0" cellspacing="0" cellpadding="0">
      ...
      <?php if ($_GET['agentsite']=='win12u') { ?>
      <tr>
        <th scope="row"><label>TAC:</label></th>
        <td><input type="TAC" class="validate[required]" name="TAC" id="TAC" value="" /></td>
      </tr>
      <?php } ?>
      <!-- <tr>
        <th scope="row">&nbsp;</th>
      ...
      <tr>
        <th scope="row">&nbsp;</th>
        <td><input class="button" type="submit" name="submit" value="Login" />
            <?php if ($_GET['agentsite']=='win12u') { ?>
                <input type="hidden" name="agentsite" value="<?php echo $_GET['agentsite']; ?>" />
            <?php } ?>
        </td>
      </tr>
      <tr>
        <th scope="row">&nbsp;</th>
        <td class='subtext'><div class="forgot_password"><a href="<?php echo $data['config']['SITE_DIR']; ?>/agent/agent/forgotpassword">Forgot your password?</a></div></td>
      </tr>
    </table>
  </form>
</div>
