...
<?php if ($data['page']['agent_add']['error']['count']>0) { ?>
    <div class="error">
        <ul>
            ...
            <?php if ($data['page']['agent_add']['error']['PlatformEmail1']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail1']; ?> exists in the database. Please try again with another Agent Email 1.</li><?php } ?>
            <?php if ($data['page']['agent_add']['error']['PlatformEmail2']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail2']; ?> exists in the database. Please try again with another Agent Email 2.</li><?php } ?>
            <?php if ($data['page']['agent_add']['error']['PlatformEmail3']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail3']; ?> exists in the database. Please try again with another Agent Email 3.</li><?php } ?>
            <?php if ($data['page']['agent_add']['error']['PlatformEmail4']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail4']; ?> exists in the database. Please try again with another Agent Email 4.</li><?php } ?>
            <?php if ($data['page']['agent_add']['error']['PlatformEmail5']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail5']; ?> exists in the database. Please try again with another Agent Email 5.</li><?php } ?>
            <?php if ($data['page']['agent_add']['error']['PlatformEmail6']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail6']; ?> exists in the database. Please try again with another Agent Email 6.</li><?php } ?>
            <?php if ($data['page']['agent_add']['error']['PlatformEmail7']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail7']; ?> exists in the database. Please try again with another Agent Email 7.</li><?php } ?>
            <?php if ($data['page']['agent_add']['error']['PlatformEmail8']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail8']; ?> exists in the database. Please try again with another Agent Email 8.</li><?php } ?>
            <?php if ($data['page']['agent_add']['error']['PlatformEmail9']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail9']; ?> exists in the database. Please try again with another Agent Email 9.</li><?php } ?>
            <?php if ($data['page']['agent_add']['error']['PlatformEmail10']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail10']; ?> exists in the database. Please try again with another Agent Email 10.</li><?php } ?>
            <?php if ($data['page']['agent_add']['error']['Company']==1) { ?><li>The Domain <?php echo $data['form_param']['Company']; ?> is invalid or exists in the database. Please try again with another Domain.</li><?php } ?>
            ...
            <?php for ($i=0; $i<$data['content_param']['product_list']['count']; $i++) { ?>
              <?php if($i % 2==0){ ?>
                    ...
                    <?php } ?>
                        ...
                        <td><input type="checkbox" name="Product[]" value="<?php echo $data['content_param']['product_list'][$i]['ID']; ?>" checked onclick="return false;" onkeydown="return false;">&nbsp;<?php echo $data['content_param']['product_list'][$i]['Name']; ?>&nbsp;&nbsp;</td>
                    <?php if($i % 2!==0 && ($i!==0)){ ?>
...
<!--<tr>
    ...
    <tr>
      ...
      <td>
          <input name="Host" type="text" class="validate[required,maxSize[6]]" value="<?php echo $data['form_param']['Host']; ?>" size="8" maxlength='6' />.<?php echo $data['domain']; ?>
...
<!--<tr>
    ...
    <tr>
      ...
      <td><input name="BackgroundColour" type="text" class="validate[] cpicker disabled" value="<?php echo $data['form_param']['Colour']; ?>" size="30" readonly="readonly" /></td>
    </tr>
    <tr>
      <th scope="row"><label>Font Color</label></th>
      <td><input name="FontColour" type="text" class="validate[] cpicker disabled" value="<?php echo $data['form_param']['Colour']; ?>" size="30" readonly="readonly" /></td>
    </tr>
    <tr>
      <th scope="row"><label>Logo</label></th>
      <td><input name="Logo" type="file" value="<?php echo $data['Logo']; ?> disabled" readonly="readonly" /><br />
