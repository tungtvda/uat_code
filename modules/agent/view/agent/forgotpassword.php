<?php if ($data['page']['agent_forgotpassword']['error']['count']>0) { ?>
    <?php if ($data['page']['agent_forgotpassword']['error']['NoMatch']==1) { ?>
...
<form name="forgotpassword_form" class="admin_table_noMobile"  id="forgotpassword_form" action="<?php echo $data['config']['SITE_DIR']; ?>/agent/agent/forgotpasswordprocess" method="post">
