<?php if ($data['page']['agent_profile']['error']['count']>0) { ?>
    <div class="error">
        <ul>
            ...
            <?php if ($data['page']['agent_profile']['error']['PlatformEmail1']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail1']; ?> exists in the database. Please try again with another Agent Email 1.</li><?php } ?>
            <?php if ($data['page']['agent_profile']['error']['PlatformEmail2']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail2']; ?> exists in the database. Please try again with another Agent Email 2.</li><?php } ?>
            <?php if ($data['page']['agent_profile']['error']['PlatformEmail3']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail3']; ?> exists in the database. Please try again with another Agent Email 3.</li><?php } ?>
            <?php if ($data['page']['agent_profile']['error']['PlatformEmail4']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail4']; ?> exists in the database. Please try again with another Agent Email 4.</li><?php } ?>
            <?php if ($data['page']['agent_profile']['error']['PlatformEmail5']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail5']; ?> exists in the database. Please try again with another Agent Email 5.</li><?php } ?>
            <?php if ($data['page']['agent_profile']['error']['PlatformEmail6']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail6']; ?> exists in the database. Please try again with another Agent Email 6.</li><?php } ?>
            <?php if ($data['page']['agent_profile']['error']['PlatformEmail7']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail7']; ?> exists in the database. Please try again with another Agent Email 7.</li><?php } ?>
            <?php if ($data['page']['agent_profile']['error']['PlatformEmail8']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail8']; ?> exists in the database. Please try again with another Agent Email 8.</li><?php } ?>
            <?php if ($data['page']['agent_profile']['error']['PlatformEmail9']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail9']; ?> exists in the database. Please try again with another Agent Email 9.</li><?php } ?>
            <?php if ($data['page']['agent_profile']['error']['PlatformEmail10']==1) { ?><li>The Email: <?php echo $data['form_param']['PlatformEmail10']; ?> exists in the database. Please try again with another Agent Email 10.</li><?php } ?>
        </ul>
    </div>
<?php } else { ?>
...
<form name="profile_form" class="admin_table_nocell"  id="profile_form" action="<?php echo $data['config']['SITE_DIR']; ?>/agent/agent/profileprocess/<?php echo $data['content'][0]['ID']; ?>" enctype="multipart/form-data" method="post">
  <table border="0" Mobilespacing="0" Mobilepadding="0">
      ...
      <td>
          ...
          <?php }*/ ?>
              <div>
                  <?php // Only show when assigned to this platform ?>
                ...
                <?php for ($z=0; $z<$data['content_param']['product']['count']; $z++) {
                    if ($data['content_param']['product_list'][$i]['ID']==$data['content_param']['product'][$z]){ ?>checked="checked"<?php } } ?> onclick="return false;" onkeydown="return false;">&nbsp;<?php echo $data['content_param']['product_list'][$i]['Name']; ?>&nbsp;&nbsp;
