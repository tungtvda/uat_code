...
<div align="center"><img src="http://www.win12u.com/images/in1u.jpg" width="776" height="231" />
  ...
  <?php if ($data['page']['member_login']['error']['count']>0) { ?>
    ...
    <?php } ?>
  <?php } ?>
  <form name="login_form" id="login_form" method="post" action="<?php echo $data['config']['SITE_DIR']; ?>/member/reseller/loginprocess">
    <table border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <th scope="row">&nbsp;</th>
        <td class='subtext'><div class="forgot_password"><a href="<?php echo $data['config']['SITE_DIR']; ?>/member/reseller/forgotpassword">Forgot your password?</a></div></td>
      </tr>
    </table>
  </form>
</div>
