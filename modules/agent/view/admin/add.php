<?php if ($data['page']['admin_add']['error']['count']>0) { ?>
    <div class="error">
        <ul>
            ...
            <?php if ($data['page']['admin_add']['error']['Company']==1) { ?><li>The Company URL <?php echo $data['form_param']['Company']; ?> is invalid or exists in the database. Please try again with another Company URL.</li><?php } ?>
        </ul>
    </div>
<?php } ?>
  ...
  <table border="0" Mobilespacing="0" Mobilepadding="0">
    ...
    <tr>
      ...
      <td><select name="ParentID" class="validate[] chosen">
                        ...
                        <option value="<?php echo $data['content_param']['agent_list'][$i]['ID']; ?>" <?php if($data['form_param']['ParentID']==$data['content_param']['agent_list'][$i]['ID']){ ?> selected="selected" <?php } ?>><?php echo $data['content_param']['agent_list'][$i]['Name']; ?> - <?php echo $data['content_param']['agent_list'][$i]['ID']; ?> | <?php echo $data['content_param']['agent_list'][$i]['Company']; ?></option>
                        <?php } ?>
                  </select>
          </td>
    </tr>
...
<!--<tr>
    ...
    <tr>
      ...
      <td><input name="Company" class="validate[required]" type="text" value="<?php echo $data['form_param']['Company']; ?>" size="40" /><span class="label_hint">(Please DO NOT include http:// in front of URL, e.g. <b>host123.domain.com</b>)</span></td>
    </tr>
    <!--<tr>
    ...
    <tr>
      ...
      <td><select name="Bank" class="validate[required] chosen">
