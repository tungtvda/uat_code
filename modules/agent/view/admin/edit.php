...
<?php if ($data['page']['admin_edit']['error']['count']>0) { ?>
    <div class="error">
        <ul>
            ...
            <?php if ($data['page']['admin_edit']['error']['Company']==1) { ?><li>The Company URL <?php echo $data['form_param']['Company']; ?> is invalid or exists in the database. Please try again with another Company URL.</li><?php } ?>
        </ul>
    </div>
<?php } else { ?>
  ...
  <table border="0" Mobilespacing="0" Mobilepadding="0">
          ...
          <?php if($i % 2==0){ ?>
            ...
            <?php } ?>
              ...
              <?php for ($z=0; $z<$data['content_param']['product']['count']; $z++) {
                  if ($data['content_param']['product_list'][$i]['ID']==$data['content_param']['product'][$z]) { ?>checked="checked"<?php } } ?>>&nbsp;<?php echo $data['content_param']['product_list'][$i]['Name']; ?>&nbsp;&nbsp;</td>
              <?php if($i % 2!==0 && ($i!==0)){ ?>
            </tr>
          <?php } ?>
          <?php } ?>
    ...
    <tr>
      ...
      <td><select name="ParentID" class="validate[] chosen">
                        ...
                        <option value="<?php echo $data['content_param']['agent_list'][$i]['ID']; ?>" <?php if($data['content'][0]['ParentID']==$data['content_param']['agent_list'][$i]['ID']){ ?> selected="selected" <?php } ?>><?php echo $data['content_param']['agent_list'][$i]['Name']; ?> - <?php echo $data['content_param']['agent_list'][$i]['ID']; ?> | <?php echo $data['content_param']['agent_list'][$i]['Company']; ?></option>
                        <?php } ?>
                  </select>
          </td>
    </tr>
...
<!--<tr>
    ...
    <tr>
      ...
      <td><input name="Company" type="text" class="validate[required]" value="<?php echo (($data['form_param']['Company']!="") ? $data['form_param']['Company'] : $data['content'][0]['Company']); ?>" size="40" /><span class="label_hint">(Please DO NOT include http:// in front of URL, e.g. <b>host123.domain.com</b>)</span></td>
    </tr>
    <!--<tr>
