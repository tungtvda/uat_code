  ...
  <table border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
     ...
     <tr>
      ...
      <td><input name="DateDeposit" class="validate[required,custom[dmyDateTime]] datepicker mask_date" type="text" value="" size="25" maxlength="25" /><span class="label_hint">(dd-mm-yyyy hh:mm:ss)</span></td>
    </tr>
    <tr>
      <th scope="row"></th>
