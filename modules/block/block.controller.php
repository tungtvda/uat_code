...
{
	protected $controller_name = "block";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['block_add'] = $param['status'];
        
        if ($param['status']['ok']=="1")
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/block/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/block/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_DIR']."/admin/block/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['block_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/block/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/block/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['block_delete'] = $param['status'];
