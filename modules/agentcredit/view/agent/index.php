...
<div id="search_box"<?php if ($data['content_param']['search']=="off") { ?>class="search_initial"<?php } ?>>
  ...
  <div id="search_content" <?php if ($data['content_param']['search']=="off") { ?>class="invisible"<?php } ?>>
	  ...
	  <form name="search_form" class="admin_table_nocell"  id="search_form" action="<?php echo $data['config']['SITE_DIR']; ?>/agent/agentcredit/index" method="post">
	    ...
	    <table border="0" cellspacing="0" cellpadding="0" style="width:100%">
	      ...
	      <tr>
	        ...
	        <td><input name="DateFrom" class="datepicker" type="text" value="<?php echo $_SESSION['agentcredit_AgentIndex']['param']['DateFrom']; ?>" size="20" />
            ...
            <td><select name="TypeID" class="chosen">
                ...
                <option value="<?php echo $data['content_param']['transactiontype_list'][$i]['ID']; ?>" <?php if ($data['content_param']['transactiontype_list'][$i]['ID']==$_SESSION['agentcredit_AgentIndex']['param']['TypeID']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['transactiontype_list'][$i]['Label']; ?></option>
                <?php } ?>
              </select>
            </td>
	      ...
	      <tr>
	        ...
	        <td><input name="DateTo" class="defaultdatepicker" type="text" value="<?php echo $_SESSION['agentcredit_AgentIndex']['param']['DateTo']; ?>" size="20" />
	          (yyyy-mm-dd hh:mm:ss)</td>
	        <td>&nbsp;</td>	
            ...
            <td><select name="Status" class="chosen_simple">
                ...
                <option value="<?php echo $data['content_param']['transactionstatus_list'][$i]['ID']; ?>" <?php if ($data['content_param']['transactionstatus_list'][$i]['ID']==$_SESSION['agentcredit_AgentIndex']['param']['Status']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['transactionstatus_list'][$i]['Label']; ?></option>
                <?php } ?>
              </select></td>
	      </tr>
	      <tr>
	      	<th>Description</th>
            <td><input name="Description" type="text" value="<?php echo $_SESSION['agentcredit_AgentIndex']['param']['Description']; ?>" /></td>
	        <td>&nbsp;</td>
	        <td>&nbsp;</td>
	        <td>&nbsp;</td>  
	      </tr>
	    ...
	    <!--<tr>
	      ...
	      <tr>
	        ...
	        <td class="text_right"><input type="submit" name="submit" value="Search" class="button" />
	          <a href="<?php echo $data['config']['SITE_DIR']; ?>/agent/agentcredit/index?page=all">
...
<div class="admin_results">
 ...
 <tr>	
	<th class="text_right">Deposit (RM)</th>
        ...
        <th class="text_right">Real Balance (RM)</th>
 </tr>
 <tr class="color">
  	<td class="text_right"><?php echo ($data['report']['TotalIn']=='0.00')? '0.00':$data['report']['TotalIn']; ?></td>
        <td class="text_right"><?php echo ($data['report']['TotalOut']=='0.00')? '0.00':'-'.$data['report']['TotalOut']; ?></td>
        <td class="text_right"><?php echo $data['report']['Balance']; ?></td>
        <td class="text_right"><?php echo $_SESSION['profitLoss']; ?></td> 
        <td class="text_right"><?php Core::getHook('Credit-Balance'); ?></td>
  </tr> 
</table>
<?php if ($data['content_param']['count']>0) { ?>
...
<table class="admin_table" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><div align="center"><a href='<?php echo $data['config']['SITE_DIR']; ?>/agent/agentcredit/delete/<?php echo $data['content'][$i]['ID']; ?>' onclick='return call_confirm()'>Delete</a></div></td>
   <?php } ?>
    <?php if($_SESSION['agent']['operator']['ProfileID']=='2' || $_SESSION['agent']['operator']['ProfileID']=='3'){ ?>
    <td><div align="center"><a href='<?php echo $data['config']['SITE_DIR']; ?>/agent/agentcredit/edit/<?php echo $data['content'][$i]['ID']; ?>'>Edit</a></div></td>
