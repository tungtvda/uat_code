<form action="<?php echo $data['config']['SITE_URL']; ?>/admin/listing/addprocess" method="post" enctype="multipart/form-data" name="add_form" class="admin_table_nocell"  id="add_form">
  <table border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td><select name="TypeID" class="chosen">
            ...
            <option value="<?php echo $data['content_param']['listingtype_list'][$i]['ID']; ?>" <?php if ($data['content_param']['listingtype_list'][$i]['ID']==$_SESSION['listing_AdminIndex']['param']['TypeID']) { ?> selected="selected"<?php } ?>><?php //echo $data['content_param']['listingtype_list'][$i]['ID']; ?><?php echo $data['content_param']['listingtype_list'][$i]['Label']; ?></option>
            <?php } ?>
          </select></td>
    </tr>
    <tr>
    ...
    <tr>
      <th scope="row"><label>BrandName<span class="label_required">*</span></label></th>
    ...
    <tr>
      ...
      <td><input type="submit" name="submit" value="Add" class="button" />
        <a href="<?php echo $data['config']['SITE_URL']; ?>/admin/listing/index">
