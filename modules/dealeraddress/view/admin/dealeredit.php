<?php if ($data['page']['dealeraddress_dealeradd']['error']['count']>0) { ?>
<?php } else { ?>
    <?php if ($data['page']['dealeraddress_dealeradd']['ok']==1) { ?>
    <div class="notify">Address created successfully.</div>
    <?php } ?>
<?php } ?>
<?php if ($data['page']['dealeraddress_dealeredit']['error']['count']>0) { ?>
<?php } else { ?>
    <?php if ($data['page']['dealeraddress_dealeredit']['ok']==1) { ?>
    <div class="notify">Address edited successfully.</div>
    <?php } ?>
<?php } ?>
<form name="edit_form" class="admin_table_nocell"  id="edit_form" enctype="multipart/form-data" action="<?php echo $data['config']['SITE_URL']; ?>/admin/dealeraddress/dealereditprocess/<?php echo $data['parent']['id']; ?>,<?php echo $data['content'][0]['ID']; ?>" method="post">
  <table border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td><input type="submit" name="submit" value="Update" class="button" />
        <a href="<?php echo $data['config']['SITE_URL']; ?>/admin/dealeraddress/dealerindex/<?php echo $data['parent']['id']; ?>">
