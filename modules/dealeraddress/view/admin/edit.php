<?php if ($data['page']['dealeraddress_add']['error']['count']>0) { ?>
<?php } else { ?>
    <?php if ($data['page']['dealeraddress_add']['ok']==1) { ?>
    <div class="notify">Dealer Address created successfully.</div>
    <?php } ?>
<?php } ?>
<?php if ($data['page']['dealeraddress_edit']['error']['count']>0) { ?>
<?php } else { ?>
    <?php if ($data['page']['dealeraddress_edit']['ok']==1) { ?>
  ...
  <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td><select name="DealerID" class="chosen_simple">
          ...
          <option value="<?php echo $data['content_param']['dealer_list'][$i]['ID']; ?>" <?php if ($data['content_param']['dealer_list'][$i]['ID']==$data['content'][0]['DealerID']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['dealer_list'][$i]['Name']; ?></option>
          <?php } ?>
        </select></td>
    </tr>
    <tr>
