<form name="add_form" class="admin_table_nocell" id="add_form" action="<?php echo $data['config']['SITE_DIR']; ?>/admin/agentblock/addprocess" enctype="multipart/form-data" method="post">
  <table border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td><textarea name="Content" id="Description" class="full_width validate[required] ckeditor" rows="5"></textarea></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <input type="hidden" id="AddFormPost" name="AddFormPost" value="1" /> <a href="<?php echo $data['config']['SITE_DIR']; ?>/admin/agentblock/index"><input type="button" value="Cancel" class="button" /></a></td>
    </tr>
  </table>
</form>
