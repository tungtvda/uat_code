...
{
	protected $controller_name = "orderstatus";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['orderstatus_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/orderstatus/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/orderstatus/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_URL']."/admin/orderstatus/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['orderstatus_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/orderstatus/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/orderstatus/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['orderstatus_delete'] = $param['status'];
