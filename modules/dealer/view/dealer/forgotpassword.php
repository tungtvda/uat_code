<?php if ($data['page']['dealer_forgotpassword']['error']['count']>0) { ?>
    <?php if ($data['page']['dealer_forgotpassword']['error']['NoMatch']==1) { ?>
...
<form name="forgotpassword_form" class="admin_table_noMobile"  id="forgotpassword_form" action="<?php echo $data['config']['SITE_URL']; ?>/dealer/dealer/forgotpasswordprocess" method="post">
