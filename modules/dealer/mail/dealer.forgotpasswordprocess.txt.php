...
To protect your account, please login to your account immediately at <?php echo $param['config']['SITE_URL']; ?><?php echo $param['config']['SITE_URL']; ?> and change your password. Thank you.
