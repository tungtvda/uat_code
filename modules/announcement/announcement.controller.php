...
{
	protected $controller_name = "announcement";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['announcement_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/announcement/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/announcement/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_DIR']."/admin/announcement/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['announcement_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/announcement/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/announcement/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['announcement_delete'] = $param['status'];
