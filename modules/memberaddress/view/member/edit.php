<?php if ($data['page']['memberaddress_add']==1) { ?>
<div class="notify">Member Address created successfully.</div>
<?php } ?>
<?php if ($data['page']['memberaddress_edit']==1) { ?>
<div class="notify">Member Address edited successfully.</div>
<?php } ?>
<?php if ($data['page']['memberaddress_edit']==2) { ?>
<div class="notify">Member Address edited, but no changes were made.</div>
<?php } ?>
<form name="edit_form" class="admin_table_nocell"  id="edit_form" action="<?php echo $data['config']['SITE_DIR']; ?>/admin/memberaddress/editprocess/<?php echo $data['content'][0]['ID']; ?>" method="post">
  <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td><select name="MemberID" class="chosen_simple">
          ...
          <option value="<?php echo $data['content_param']['member_list'][$i]['ID']; ?>" <?php if ($data['content_param']['member_list'][$i]['ID']==$data['content'][0]['MemberID']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['member_list'][$i]['FirstName']; ?></option>
          <?php } ?>
        </select></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="submit" name="submit" value="Update" class="button" />
        <a href="<?php echo $data['config']['SITE_DIR']; ?>/admin/memberaddress/index">
