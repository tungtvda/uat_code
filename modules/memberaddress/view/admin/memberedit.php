<?php if ($data['page']['memberaddress_memberadd']['error']['count']>0) { ?>
<?php } else { ?>
    <?php if ($data['page']['memberaddress_memberadd']['ok']==1) { ?>
    <div class="notify">Address created successfully.</div>
    <?php } ?>
<?php } ?>
<?php if ($data['page']['memberaddress_memberedit']['error']['count']>0) { ?>
<?php } else { ?>
    <?php if ($data['page']['memberaddress_memberedit']['ok']==1) { ?>
    <div class="notify">Address edited successfully.</div>
    <?php } ?>
<?php } ?>
<form name="edit_form" class="admin_table_nocell"  id="edit_form" enctype="multipart/form-data" action="<?php echo $data['config']['SITE_DIR']; ?>/admin/memberaddress/membereditprocess/<?php echo $data['parent']['id']; ?>,<?php echo $data['content'][0]['ID']; ?>" method="post">
  <table border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td><input type="submit" name="submit" value="Update" class="button" />
        <a href="<?php echo $data['config']['SITE_DIR']; ?>/admin/memberaddress/memberindex/<?php echo $data['parent']['id']; ?>">
