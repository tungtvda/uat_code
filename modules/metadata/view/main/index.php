...
<?php /*?><div id="petlost_wrapper">
  ...
  <div class="petlost_list_box">
    ...
    <div class="petlost_more"><a href="<?php echo $data['config']['SITE_URL']; ?>/main/petlost/view/<?php echo $data['content'][$i]['ID']; ?>">Read more &raquo;</a></div>
  </div>
  <?php } ?>
...
<div class="petlost_list_box block_common_pet clear">
  <?php /*?><h2><a href="<?php echo $data['config']['SITE_URL']; ?>/main/petlost/view/<?php echo $data['content']['petlost'][$i]['ID']; ?>"><?php echo $data['content'][$i]['Name']; ?></a></h2><?php */?>
