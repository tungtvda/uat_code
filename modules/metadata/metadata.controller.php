...
{
	protected $controller_name = "metadata";
	...
	protected function AddProcess()
	{
        ...
        {
			$_SESSION['admin']['metadata_add'] = $param['status'];
	        
	        if ($param['status']['ok']=="1") 
			{
				Helper::redirect($param['config']['SITE_URL']."/admin/metadata/edit/".$param['content_param']['newID']);
			} 
			else 
			{
				Helper::redirect($param['config']['SITE_URL']."/admin/metadata/add/");
			}
        }
        else if ($this->section=='api')
        {
	...
	protected function Edit() 
	{
        ...
        else if ($this->section=='admin')
        {
	        ...
	        {
	            Helper::redirect($param['config']['SITE_URL']."/admin/metadata/index");
	        }
        }
        else if ($this->section=='api')
        {
	...
	protected function EditProcess() 
	{
        ...
        {
			$_SESSION['admin']['metadata_edit'] = $param['status'];
	        
	        if ($param['status']['ok']=="1") 
			{
				Helper::redirect($param['config']['SITE_URL']."/admin/metadata/edit/".$this->id);
			} 
			else 
			{
				Helper::redirect($param['config']['SITE_URL']."/admin/metadata/edit/".$this->id);
	...
	protected function Delete() 
	{
        ...
        {
			$_SESSION['admin']['metadata_delete'] = $param['status'];
