...
class PermissionMode extends BaseController 
{
	protected $controller_name = "permissionmode";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['permissionmode_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/permissionmode/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/permissionmode/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_URL']."/admin/permissionmode/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['permissionmode_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/permissionmode/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/permissionmode/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['permissionmode_delete'] = $param['status'];
