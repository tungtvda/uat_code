...
{
	protected $controller_name = "message";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['message_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/message/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/message/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_DIR']."/admin/message/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['message_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/message/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/message/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['message_delete'] = $param['status'];
