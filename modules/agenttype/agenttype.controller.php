...
class AgentType extends BaseController 
{
	protected $controller_name = "agenttype";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['agenttype_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/agenttype/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/agenttype/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_DIR']."/admin/agenttype/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['agenttype_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/agenttype/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/agenttype/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['agenttype_delete'] = $param['status'];
