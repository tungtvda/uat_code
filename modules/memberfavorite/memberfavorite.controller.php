...
class MemberFavorite extends BaseController 
{
	protected $controller_name = "memberfavorite";
	...
	protected function UnlikeProcess()
	{
        if ($this->section=='main')
        {
        	Helper::redirect404();
	...
	protected function LikeProcess()
	{
        if ($this->section=='main')
        {
        	Helper::redirect404();
	...
	protected function Edit() 
	{
        ...
        else if ($this->section=='admin')
        {
	        ...
	        {
	            Helper::redirect($param['config']['SITE_URL']."/admin/memberfavorite/index");
	        }
        }
        else if ($this->section=='api')
        {
	...
	protected function EditProcess() 
	{
        ...
        {
			$_SESSION['admin']['memberfavorite_edit'] = $param['status'];
	        
	        if ($param['status']['ok']=="1") 
			{
				Helper::redirect($param['config']['SITE_URL']."/admin/memberfavorite/edit/".$this->id);
			} 
			else 
			{
				Helper::redirect($param['config']['SITE_URL']."/admin/memberfavorite/edit/".$this->id);
	...
	protected function Delete() 
	{
        ...
        {
			$_SESSION['admin']['memberfavorite_delete'] = $param['status'];
