...
class Transaction extends BaseController
{
	...
	protected function DepositProcess()
	{
		...
		if($param==0)
		{
			echo "<script>alert('Voucher code of Password is invalid, please check again')</script>";
			Helper::redirect($param['config']['SITE_DIR']."/member/transaction/deposit");
		}
    ...
    protected function SendMail($message, $param)
    {
        ...
        if ($param['agent_type'] == '2')
        {
            ...
            $mailer->AddBCC($param['config']['TRX_EMAIL_CC1'], '');
            $mailer->AddBCC($param['config']['TRX_EMAIL_CC2'], '');
            $mailer->AddBCC($param['config']['TRX_EMAIL_CC3'], '');
            $mailer->AddBCC($param['config']['TRX_EMAIL_CC4'], '');
            $mailer->AddBCC($param['config']['TRX_EMAIL_CC5'], '');
            $mailer->AddBCC($param['config']['TRX_EMAIL_CC6'], '');
            $mailer->AddBCC($param['config']['TRX_EMAIL_CC7'], '');
            $mailer->AddBCC($param['config']['TRX_EMAIL_CC8'], '');
            $mailer->AddBCC($param['config']['TRX_EMAIL_CC9'], '');
            $mailer->AddBCC($param['config']['TRX_EMAIL_CC10'], '');
            $mailer->AddBCC($param['config']['TRX_EMAIL_CC11'], '');
            $mailer->AddBCC($param['config']['TRX_EMAIL_CC12'], '');
            $mailer->AddBCC($param['config']['TRX_EMAIL_CC13'], '');
            $mailer->AddBCC($param['config']['TRX_EMAIL_CC14'], '');
            $mailer->AddBCC($param['config']['TRX_EMAIL_CC15'], '');

            //platform operator
            $mailer->AddAddress($param['agent_parent']['Email'], '');
            $mailer->AddBCC($param['agent_parent']['PlatformEmail1'], '');
            $mailer->AddBCC($param['agent_parent']['PlatformEmail2'], '');
            $mailer->AddBCC($param['agent_parent']['PlatformEmail3'], '');
            $mailer->AddBCC($param['agent_parent']['PlatformEmail4'], '');
            $mailer->AddBCC($param['agent_parent']['PlatformEmail5'], '');
            $mailer->AddBCC($param['agent_parent']['PlatformEmail6'], '');
            $mailer->AddBCC($param['agent_parent']['PlatformEmail7'], '');
            $mailer->AddBCC($param['agent_parent']['PlatformEmail8'], '');
            $mailer->AddBCC($param['agent_parent']['PlatformEmail9'], '');
            $mailer->AddBCC($param['agent_parent']['PlatformEmail10'], '');
        ...
        else if ($param['agent_type'] == '1')
        {
            ...
            // Own
            $mailer->AddAddress($param['agent']['Email'], '');
            $mailer->AddBCC($param['agent']['PlatformEmail1'], '');
            $mailer->AddBCC($param['agent']['PlatformEmail2'], '');
            $mailer->AddBCC($param['agent']['PlatformEmail3'], '');
            $mailer->AddBCC($param['agent']['PlatformEmail4'], '');
            $mailer->AddBCC($param['agent']['PlatformEmail5'], '');
            $mailer->AddBCC($param['agent']['PlatformEmail6'], '');
            $mailer->AddBCC($param['agent']['PlatformEmail7'], '');
            $mailer->AddBCC($param['agent']['PlatformEmail8'], '');
            $mailer->AddBCC($param['agent']['PlatformEmail9'], '');
            $mailer->AddBCC($param['agent']['PlatformEmail10'], '');
	...
	protected function checkCode(){
		if(isset($_GET['password_code'])){
			$password_code=addslashes(strip_tags($_GET['password_code']));
		}
		else{
			$password_code='';
		}
		if(isset($_GET['code_card_val'])){
			$code_card_val=addslashes(strip_tags($_GET['code_card_val']));
		}
		else{
			$code_card_val='';
		}
		$start = $this->Start();
		$loadModel = $this->prefix.__FUNCTION__;
		$param = $start->$loadModel($code_card_val,$password_code);
		echo $param;
