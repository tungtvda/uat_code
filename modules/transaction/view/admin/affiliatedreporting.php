...
<?php for ($i = 0; $i < $data['content']['count']; $i++) { ?>
  <tr class="color">
      <td class="center"><a href="<?php echo $data['config']['SITE_URL'].$data['config']['SITE_DIR']; ?>/admin/transaction/affiliatedreporting/<?php echo $data['content'][$i]['ID'];  ?>"><?php echo $data['content'][$i]['Username']; ?></a></td>
...
<tr class="noBorder">
 ...
 <tr class="color">
     <td class="center"><a href="<?php echo $data['config']['SITE_URL'].$data['config']['SITE_DIR']; ?>/admin/transaction/affiliatedreporting/<?php echo $data['currentAgent'][$i]['ID'];  ?>"><?php echo $data['currentAgent'][$i]['Username']; ?></a></td>
