...
<div style="margin-bottom:15px;">
    <form name="reseller_form" class="admin_table_nocell" id="reseller_form">
        Reseller:
        <select name="Reseller_ID" class="chosen" id="Reseller_ID">
            <option value="">- Select reseller -</option>
            <?php for ($i=0; $i<$data['content_param']['reseller_list']['count']; $i++) { ?>
            <option value="/admin/transaction/reseller/<?php echo $data['content_param']['reseller_list'][$i]['ID']; ?>?page=all" <?php if ($data['content_param']['reseller_list'][$i]['ID']==$_GET['id']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['reseller_list'][$i]['Name']; ?> (<?php echo $data['content_param']['reseller_list'][$i]['Company']; ?>)</option>
            <?php } ?>
        </select>
    </form>
</div>
...
<div id="search_box"<?php if ($data['content_param']['search']=="off") { ?>class="search_initial"<?php } ?>>
  ...
  <div id="search_content" <?php if ($data['content_param']['search']=="off") { ?>class="invisible"<?php } ?>>
	  ...
	  <form name="search_form" class="admin_table_nocell"  id="search_form" action="<?php echo $data['config']['SITE_DIR']; ?>/admin/transaction/reseller/<?php echo $data['ID']; ?>" method="post">
	    ...
	    <table border="0" cellspacing="0" cellpadding="0" style="width:100%">
	      ...
	      <tr>
	        ...
	        <td><input name="DateFrom" class="datepicker" type="text" value="<?php echo $_SESSION['transaction_AdminReseller']['param']['t.DateFrom']; ?>" size="20" />
            ...
            <td><select name="TypeID" class="chosen">
                ...
                <option value="<?php echo $data['content_param']['transactiontype_list'][$i]['ID']; ?>" <?php if ($data['content_param']['transactiontype_list'][$i]['ID']==$_SESSION['transaction_AdminReseller']['param']['t.TypeID']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['transactiontype_list'][$i]['Label']; ?></option>
                <?php } ?>
              </select>
            </td>
	      ...
	      <tr>
	        ...
	        <td><input name="DateTo" class="defaultdatepicker" type="text" value="<?php echo $_SESSION['transaction_AdminReseller']['param']['t.DateTo']; ?>" size="20" />
	          (yyyy-mm-dd hh:mm:ss)</td>
	        <td>&nbsp;</td>
            ...
            <td><select name="Status" class="chosen_simple">
                ...
                <option value="<?php echo $data['content_param']['transactionstatus_list'][$i]['ID']; ?>" <?php if ($data['content_param']['transactionstatus_list'][$i]['ID']==$_SESSION['transaction_AdminReseller']['param']['t.Status']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['transactionstatus_list'][$i]['Label']; ?></option>
                <?php } ?>
              </select></td>
	      </tr>
	      <tr>
            ...
            <td><select name="MemberID" class="chosen">
                ...
                <option value="<?php echo $data['content_param']['member_list'][$i]['ID']; ?>" <?php if ($data['content_param']['member_list'][$i]['ID']==$_SESSION['transaction_AdminReseller']['param']['t.MemberID']) { ?> selected="selected"<?php } ?>><?php echo $data['content_param']['member_list'][$i]['Name']; ?> | <?php echo $data['content_param']['member_list'][$i]['Username']; ?> | <?php echo $data['content_param']['member_list'][$i]['AgentURL']; ?></option>
                <?php } ?>
              </select>
            </td>
            <td>&nbsp;</td>
	    ...
	    <tr>
	        ...
	        <td>
                    <input name="BankSlip" class="" type="text" value="<?php echo $_SESSION['transaction_AdminReseller']['param']['t.BankSlip']; ?>" size="20" />
                </td>
	        <td>&nbsp;</td>
	        <td>&nbsp;</td>
	        <td>&nbsp;</td>
	      ...
	      <tr>
	        ...
	        <td class="text_right"><input type="submit" name="submit" value="Search" class="button" />
	          <a href="<?php echo $data['config']['SITE_DIR']; ?>/admin/transaction/reseller/<?php echo $data['ID']; ?>?page=all">
...
<div class="admin_results">
  ...
  <div class="results_right"><!-- <a href='/admin/transaction/add/'>
    ...
    <a href='<?php echo $data['config']['SITE_DIR']; ?>/admin/transaction/resellerexport/AdminResellerEx<?php echo $data['ID']; ?>'>
    <input type="button" class="button" value="Export to CSV">
    </a>
    <?php } ?>
    </div>
 ...
 <tr>
  ...
  <tr>
    ...
    <td class="text_right"><?php echo ($data['report']['Profit']=='')? '0.00':$data['report']['Bonus']; ?></td>
    <td class="text_right"><?php echo ($data['report']['Profit']=='')? '0.00':$data['report']['Commission']; ?></td>
...
<table class="admin_table" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <th>Date & Reseller</th>
    <th width="12%">Member | Username</th>
