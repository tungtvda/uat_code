...
<form name="edit_form" class="admin_table_nocell"  id="edit_form" action="<?php echo $data['config']['SITE_DIR']; ?>/agent/transaction/editprocess/<?php echo $data['content'][0]['ID']; ?>" method="post">
  <table border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td><input name="Debit" type="text" <?php if ($_SESSION['agent']['operator']['ProfileID']>'0') { ?>readonly='readonly'<?php } ?> class="validate[custom[number]]" value="<?php echo $data['content'][0]['In']; ?>" size="10" /></td>
    </tr>
    <tr>
      <th scope="row"><label>Out (MYR)</label></th>
      <td><input name="Credit" type="text" <?php if ($_SESSION['agent']['operator']['ProfileID']>'0') { ?>readonly='readonly'<?php } ?> class="validate[custom[number]]" value="<?php echo $data['content'][0]['Out']; ?>" size="10" /></td>
    </tr>
    <tr>
      <th scope="row"><label>Transfer (MYR)</label></th>
      <td><input name="Amount" type="text" <?php if ($_SESSION['agent']['operator']['ProfileID']>'0') { ?>readonly='readonly'<?php } ?> class="validate[custom[number]]" value="<?php echo $data['content'][0]['Amount']; ?>" size="10" /></td>
    </tr>
   <!--<tr>
