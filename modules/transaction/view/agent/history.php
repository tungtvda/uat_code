...
<table class="admin_table" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <th class="text_right">Balance (MYR)</th>
  ...
  <tr>
      <td><?php echo $data['content'][$i]['Date']; ?><br/>
          Agent:<span style="color: <?php echo $data['content'][$i]['Colour'][0]['Colour']; ?>; font-size: 11px"> <?php echo $data['content'][$i]['Reseller']; ?></span>
      </td>
    ...
    <td class="center"><?php echo ($data['content'][$i]['Balance']=="")? '0.00' : $data['content'][$i]['Balance']; ?></td>
