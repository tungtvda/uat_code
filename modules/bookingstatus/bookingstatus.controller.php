...
class BookingStatus extends BaseController 
{
	protected $controller_name = "bookingstatus";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['bookingstatus_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/bookingstatus/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/bookingstatus/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_URL']."/admin/bookingstatus/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['bookingstatus_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/bookingstatus/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_URL']."/admin/bookingstatus/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['bookingstatus_delete'] = $param['status'];
