...
class ResellerCreditModel extends BaseModel
{
	private $output = array();
    private $module_name = "Reseller Credit";
	private $module_dir = "modules/resellercredit/";
    private $module_default_url = "/main/resellercredit/index";
    private $module_default_admin_url = "/admin/resellercredit/index";
    private $module_default_member_url = "/member/resellercredit/index";
	...
	public function AdminIndex($param)
	{
		...
		$crud = new CRUD();
			...
			$_SESSION['resellercredit_'.__FUNCTION__]['param']['TypeID'] = $TypeID;
			$_SESSION['resellercredit_'.__FUNCTION__]['param']['ResellerID'] = $_POST['ResellerID'];
			$_SESSION['resellercredit_'.__FUNCTION__]['param']['Description'] = $Description;
			$_SESSION['resellercredit_'.__FUNCTION__]['param']['RejectedRemark'] = $RejectedRemark;
			$_SESSION['resellercredit_'.__FUNCTION__]['param']['DateFrom'] = $DateFrom;
			$_SESSION['resellercredit_'.__FUNCTION__]['param']['DateTo'] = $DateTo;
			$_SESSION['resellercredit_'.__FUNCTION__]['param']['Debit'] = $Debit;
			$_SESSION['resellercredit_'.__FUNCTION__]['param']['Credit'] = $Credit;
			$_SESSION['resellercredit_'.__FUNCTION__]['param']['Status'] = $Status;
		...
		// Prepare Pagination
		$query_count = "SELECT COUNT(*) AS num FROM reseller_credit ".$_SESSION['resellercredit_'.__FUNCTION__]['query_condition'];
		$total_pages = $this->dbconnect->query($query_count)->fetchColumn();

		$targetpage = $data['config']['SITE_DIR'].'/admin/resellercredit/index';
		$limit = 100;
		$stages = 3;
		$page = mysql_escape_string($_GET['page']);
		if ($page) {
		...
		$sql = "SELECT * FROM reseller_credit ".$_SESSION['resellercredit_'.__FUNCTION__]['query_condition']." ORDER BY `Date` DESC LIMIT $start, $limit";
		/*echo $sql;
		exit;*/
		$result = array();
		$i = 0;
		foreach ($this->dbconnect->query($sql) as $row)
		{
			...
			'ResellerID' => ResellerModel::getReseller($row['ResellerID']),
			'Description' => $row['Description'],
		...
		ResellerModel::getResellerAdminCreditReport();
		
			
		$this->output = array(
		'config' => $this->config,
		'page' => array('title' => "Reseller Credit Transactions", 'template' => 'admin.common.tpl.php', 'custom_inc' => 'on', 'custom_inc_loc' => $this->module_dir.'inc/admin/index.inc.php', 'transaction_delete' => $_SESSION['admin']['transaction_delete']),
		...
		'content' => $result,
		'summary' => ResellerModel::getResellerAdminCreditReport(),
		'content_param' => array('count' => $i, 'total_results' => $total_pages, 'paginate' => $paginate, 'query_title' => $query_title, 'search' => $search, 'enabled_list' => CRUD::getActiveList(), 'reseller_list' => ResellerModel::getResellerList(), 'transactiontype_list' => TransactionTypeModel::getTransactionTypeList(), 'transactionstatus_list' => TransactionStatusModel::getTransactionStatusList(), 'bank_list' => BankModel::getBankList()),
		'secure' => TRUE,
		'meta' => array('active' => "on"));
	...
	public function AdminAdd()
	{
		$this->output = array(
		'config' => $this->config,
		'page' => array('title' => "Create Reseller Credit Transactions", 'template' => 'admin.common.tpl.php', 'custom_inc' => 'on', 'custom_inc_loc' => $this->module_dir.'inc/admin/add.inc.php', 'transaction_add' => $_SESSION['admin']['transaction_add']),
		'block' => array('side_nav' => $this->module_dir.'inc/admin/side_nav.transaction_common.inc.php'),
		...
		'content_param' => array('enabled_list' => CRUD::getActiveList(), 'reseller_list' => ResellerModel::getResellerList(), 'transactiontype_list' => TransactionTypeModel::getTransactionTypeList(), 'transactionstatus_list' => TransactionStatusModel::getTransactionStatusList(), 'bank_list' => BankModel::getBankList()),
		'secure' => TRUE,
		'meta' => array('active' => "on"));

		unset($_SESSION['admin']['resellercredit_add']);
	...
	{
		$key = "(TypeID, ResellerID, Description, RejectedRemark, Date, TransferTo, TransferFrom, Debit, Credit, Amount, DepositBonus, DepositChannel, ReferenceCode, Bank, StaffID, ModifiedDate, Status)";
		$value = "('".$_POST['TypeID']."', '".$_POST['ResellerID']."', '".$_POST['Description']."', '".$_POST['RejectedRemark']."', '".Helper::dateTimeDisplaySQL($_POST['Date'])."', '".$_POST['TransferTo']."', '".$_POST['TransferFrom']."', '".$_POST['Debit']."', '".$_POST['Credit']."', '".$_POST['Amount']."', '".$_POST['DepositBonus']."', '".$_POST['DepositChannel']."', '".$_POST['ReferenceCode']."', '".$_POST['Bank']."', '".$_POST['StaffID']."', '".Helper::dateDisplaySQL($_POST['ModifiedDate'])."', '".$_POST['Status']."')";

		$sql = "INSERT INTO reseller_credit ".$key." VALUES ". $value;
	...
	public function AdminEdit($param)
	{
		...
		$this->output = array(
		'config' => $this->config,
		'page' => array('title' => "Edit Reseller Credit Transactions", 'template' => 'admin.common.tpl.php', 'custom_inc' => 'on', 'custom_inc_loc' => $this->module_dir.'inc/admin/edit.inc.php', 'transaction_add' => $_SESSION['admin']['resellercredit_add'], 'transaction_edit' => $_SESSION['admin']['resellercredit_edit']),
		'block' => array('side_nav' => $this->module_dir.'inc/admin/side_nav.transaction_common.inc.php'),
		'breadcrumb' => HTML::getBreadcrumb($this->module_name,$this->module_default_admin_url,"admin",$this->config,"Edit Reseller Credit Transactions"),
		'content' => $result,
		'content_param' => array('count' => $i, 'enabled_list' => CRUD::getActiveList(), 'reseller_list' => ResellerModel::getResellerList(), 'transactiontype_list' => TransactionTypeModel::getTransactionTypeList(), 'transactionstatus_list' => TransactionStatusModel::getTransactionStatusList(), 'bank_list' => BankModel::getBankList()),
		'secure' => TRUE,
		'meta' => array('active' => "on"));
	...
	public function AdminEditProcess($param)
	{
		...
		$sql = "UPDATE reseller_credit SET TypeID='".$_POST['TypeID']."', ResellerID='".$_POST['ResellerID']."', Description='".$_POST['Description']."', RejectedRemark='".$_POST['RejectedRemark']."', Date='".Helper::dateTimeDisplaySQL($_POST['Date'])."', TransferTo='".$_POST['TransferTo']."', TransferFrom='".$_POST['TransferFrom']."', Debit='".$_POST['Debit']."', Credit='".$_POST['Credit']."', Amount='".$_POST['Amount']."', DepositBonus='".$_POST['DepositBonus']."', DepositChannel='".$_POST['DepositChannel']."', ReferenceCode='".$_POST['ReferenceCode']."', Bank='".$_POST['Bank']."', Status='".$_POST['Status']."', StaffID = '".$staff_id."', ModifiedDate = '".$modified_date."' WHERE ID='".$param."'";
	...
	{
		$sql = "DELETE FROM reseller_credit WHERE ID ='".$param."'";
		$count = $this->dbconnect->exec($sql);
...
//
...

	{
		...
		// Prepare Pagination
		$query_count = "SELECT COUNT(*) FROM reseller_credit WHERE ResellerID = '".$_SESSION['reseller']['ID']."' ".$_SESSION['resellercredit_'.__FUNCTION__]['query_condition'];
		/*echo $query_count;
		exit;*/
		$total_pages = $this->dbconnect->query($query_count)->fetchColumn();

		$targetpage = $data['config']['SITE_DIR'].'/reseller/resellercredit/index';
		$limit = 100;
		$stages = 3;
		$page = mysql_escape_string($_GET['page']);
		if ($page) {
		...
		for ($i=0; $i <$result['count'] ; $i++) {*/
			...
			//$sql = "SELECT * FROM reseller_credit WHERE MemberID = '".$result[$i]['ID']."'";
			//ORDER BY m.ProfileID ASC, m.Name
			 $sql = "SELECT * FROM reseller_credit WHERE ResellerID = '".$_SESSION['reseller']['ID']."' ".$_SESSION['resellercredit_'.__FUNCTION__]['query_condition']." Order By Date DESC LIMIT $start, $limit";
...
//
		...
		$this->output = array(
		'config' => $this->config,
		'page' => array('title' => "My Transactions", 'template' => 'reseller.common.tpl.php', 'custom_inc' => 'on', 'custom_inc_loc' => $this->module_dir.'inc/reseller/index.inc.php'), //'transaction_delete' => $_SESSION['admin']['transaction_delete']),
        'block' => array('side_nav' => $this->reseller_module_dir.'inc/reseller/side_nav.reseller.inc.php', 'common' => "false"),
        'membertotal' =>  $membertotal,
		'breadcrumb' => HTML::getBreadcrumb($this->reseller_module_name,$this->module_default_reseller_url,"",$this->config,"My Transactions"),
		'content' => $transaction,
		//'report' => $report,
		'report' => ResellerModel::getResellerCreditReport(),
	...
	public function BlockIndex() 
    {
        ...
        $sql = "SELECT * FROM reseller_credit WHERE ResellerID = '".$_SESSION['reseller']['ID']."' AND Status = '2'";
		//echo $sql;
        ...
        $this->output = array( 
        'config' => $this->config,
        'page' => array('title' => "", 'template' => 'common.tpl.php'),
