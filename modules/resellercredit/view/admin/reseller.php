	  ...
	  <form name="search_form" class="admin_table_nocell"  id="search_form" action="<?php echo $data['config']['SITE_DIR']; ?>/admin/transaction/reseller/<?php echo $data['ID']; ?>" method="post">
	    ...
	    <table border="0" cellspacing="0" cellpadding="0" style="width:100%">
	      ...
	      <tr>
	        ...
	        <td><input name="DateTo" class="datepicker" type="text" value="<?php echo $_SESSION['transaction_AdminReseller']['param']['t.DateTo']; ?>" size="20" />
	          (yyyy-mm-dd hh:mm:ss)</td>
	        <td>&nbsp;</td>	
	      ...
	      <tr>
	        ...
	        <td><input name="RejectedRemark" class="validate[]" type="text" value="<?php echo $_SESSION['transaction_AdminReseller']['param']['t.RejectedRemark']; ?>" size="10" /></td>
	      </tr>
	    <tr>
...
<table class="admin_table" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><?php echo $data['content'][$i]['Date']; ?></td>
     <td><?php echo $data['content'][$i]['MemberID']; ?> - <?php echo $data['content'][$i]['UnformattedMemberID']; ?></td>
