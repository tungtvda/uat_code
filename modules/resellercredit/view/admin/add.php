<form name="add_form" class="admin_table_nocell"  id="add_form" action="<?php echo $data['config']['SITE_DIR']; ?>/admin/resellercredit/addprocess" method="post">
  <table border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td><select name="ResellerID" class="chosen">
            ...
            <option value="<?php echo $data['content_param']['reseller_list'][$i]['ID']; ?>"><?php echo $data['content_param']['reseller_list'][$i]['Name']; ?></option>
            <?php } ?>
          </select></td>
    </tr>
    <tr>
