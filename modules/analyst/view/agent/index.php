	      ...
	      <tr>
	        <th scope="row"><label>Agent</label></th>
	      	<td>
                    ...
                    <option value="<?php echo $data['agent'][0]['ID']; ?>" <?php if($data['agent'][0]['ID']==$_SESSION['operator_AgentIndex']['param']['Agent']){ ?><?php } ?>><?php echo $data['agent'][0]['Name']; ?> - <?php echo $data['agent'][0]['ID']; ?> | <?php echo $data['agent'][0]['Company']; ?></option>
...
<div class="admin_results">
  ...
  <div class="results_right">
    <?php if($_SESSION['agent']['TypeID']=='1'){ ?>  
        ...
        <input type="button" class="button" value="Create Operator">
        </a>
    <?php } ?> 
