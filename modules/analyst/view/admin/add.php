  ...
  <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td><select name="AgentID" class="chosen_simple">
            ...
            <option value="<?php echo $data['content_param']['agent_list'][$i]['ID']; ?>" <?php if($data['content_param']['agent_list'][$i]['ID']==$data['form_param']['AgentID']){ echo 'selected="selected"';} ?>><?php echo $data['content_param']['agent_list'][$i]['Name']; ?> - <?php echo $data['content_param']['agent_list'][$i]['ID']; ?> | <?php echo $data['content_param']['agent_list'][$i]['Company']; ?></option>
            <?php } ?>
          </select></td>
    </tr>
    <tr>
