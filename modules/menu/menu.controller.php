...
class Menu extends BaseController 
{
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['menu_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/menu/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/menu/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_DIR']."/admin/menu/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['menu_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/menu/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/menu/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['menu_delete'] = $param['status'];
