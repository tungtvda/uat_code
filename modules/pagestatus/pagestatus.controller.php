...
class PageStatus extends BaseController 
{
	protected $controller_name = "pagestatus";
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['pagestatus_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/pagestatus/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/pagestatus/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_DIR']."/admin/pagestatus/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['pagestatus_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/pagestatus/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/pagestatus/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['pagestatus_delete'] = $param['status'];
