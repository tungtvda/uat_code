...
class Area extends BaseController 
{
	...
	protected function AddProcess()
	{
		...
		$_SESSION['admin']['area_add'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/area/edit/".$param['content_param']['newID']);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/area/add/");
		}
	}
	...
	protected function Edit() 
	{
        ...
        {
            Helper::redirect($param['config']['SITE_DIR']."/admin/area/index");
        }
	}
	...
	protected function EditProcess() 
	{
		...
		$_SESSION['admin']['area_edit'] = $param['status'];
        
        if ($param['status']['ok']=="1") 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/area/edit/".$this->id);
		} 
		else 
		{
			Helper::redirect($param['config']['SITE_DIR']."/admin/area/edit/".$this->id);
	...
	protected function Delete() 
	{
		...
		$_SESSION['admin']['area_delete'] = $param['status'];
