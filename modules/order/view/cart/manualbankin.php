...
<?php if($data['content']['Name']!=""){ ?>
    ...
    <table style="margin-bottom:15px;" class="member_table" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td>
        	<?php echo $_SESSION['manualbankin']['Name']; ?>
        </td>
        <td  class="text_right">
        	<?php echo $_SESSION['manualbankin']['AccountNo']; ?>
        </td>
        <td>
        	<?php echo $_SESSION['manualbankin']['Bank']; ?>
        </td>
        <td  class="text_right">
    ...
    <form action="<?php echo $data['config']['SITE_URL']; ?>/cart/order/paymentbankin/<?php echo $_SESSION['manualbankin']['ID']; ?>" method="post" id="add_form" name="add_form">
