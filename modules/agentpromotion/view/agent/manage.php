...
function familyTree($array)
	{
                ...
                {   
                      ...
                      for ($index = 0; $index < $array['count']; $index++) {
                             ...
                             if ($array[$index]['ID']==$_SESSION['agentpromotion_AgentManage']['param']['Agent']) { 
...
<div id="search_box"<?php if ($data['content_param']['search']=="off") { ?>class="search_initial"<?php } ?>>
  ...
  <div id="search_content" <?php if ($data['content_param']['search']=="off") { ?>class="invisible"<?php } ?>>
	  ...
	  <form name="search_form" class="admin_table_nocell"  id="search_form" action="<?php echo $data['config']['SITE_DIR']; ?>/agent/agentpromotion/manage" method="post">
	    ...
	    <table border="0" cellspacing="0" cellpadding="0">
	      ...
	      <tr>
	        ...
	        <td class="text_right"><input type="submit" name="submit" value="Search" class="button" />
	          <a href="<?php echo $data['config']['SITE_DIR']; ?>/agent/agentpromotion/manage?page=all">
...
<div class="admin_results">
  ...
  <div class="results_right"><a href='/agent/agentpromotion/index?page=all'>
